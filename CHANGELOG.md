...
- Collision and Geometry
  ...
  - Added dartpy wheel verification that rejects legacy collision runtime libraries, reference collision libraries, and old FCL/Bullet/ODE collision component exports from wheel artifacts.
