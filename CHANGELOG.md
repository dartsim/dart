...
- Simulation
  ...
  - Added manifest-generated serial and DART 7 `ParallelExecutor` batch LCP
    ...
    1198 larger mildly ill-conditioned batch rows for batch-size-4 serial and
  ...
  - Added DART 7 experimental CUDA LCP execution paths for fixed-iteration
    ...
    boxed, and friction-index packets now reaching 128-row standard/boxed and
    48-contact friction-index synthetic cases, grouped variable-size synthetic
    ...
    verified in default and SIMD-enabled builds at those 24-/48-/96-/128-row
    and 8-/16-/32-/48-contact direct CUDA packet sizes,
  ...
  - Added DART 7 generated correctness and single/batch benchmark coverage for
    ...
    through 96 contacts and 16x-coupled packets through 128 contacts across
    the scoped iterative solver set plus Boxed Semi-Smooth Newton. Boxed
