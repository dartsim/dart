...
- Collision and Geometry
  - Validate `SphereShape::setRadius()` to reject NaN, infinity, and non-positive values with a warning instead of crashing via assertion. ([#????](https://github.com/dartsim/dart/pull/????), [gz-physics#843](https://github.com/gazebosim/gz-physics/issues/843))
