...
* Simulation
  ...
  * Complete the 3003-body resting-scene performance target from issue #3056:
    ...
    anti-overfitting matrix and RTF `91.7203` in a fresh current-head profiled
    rerun, both with final hash `0x131b6af79a44ff90`, zero final contacts, and
    `3003 / 3003` mobile skeletons resting. Active no-deactivation scenes
    remain covered by the benchmark guardrails rather than this settled-scene
    completion claim:
    [#3056](https://github.com/dartsim/dart/issues/3056)
