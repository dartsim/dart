...
- Collision and Geometry
  ...
  - Native collision: added scalar-matching batch entry points and benchmark coverage for box-box, sphere-sphere, capsule-capsule, cylinder-cylinder, convex-convex, and mesh-mesh narrow-phase pairs.
