...
- Collision and Geometry
  ...
  - Added a collision benchmark regression checker that parses Google Benchmark JSON and compares native collision timings against the best enabled FCL, Bullet, or ODE reference result for recurring performance guardrails.
