...
- Tooling and Docs
  ...
  - Tightened GitHub Actions CI workflows with granular platform checks, single-pass docs validation, targeted pixi environment installs, shared SIMD compiler-cache setup, protected-branch push triggers, and importable Debug dartpy test builds. ([#2539](https://github.com/dartsim/dart/pull/2539))
