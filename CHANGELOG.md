...
- Simulation
  ...
  - Tightened experimental topology naming so `World` multibody names and
    `MultiBody` link/joint names are unique within their owners, autogenerated
    names skip collisions, and cross-multibody parent links are rejected.
