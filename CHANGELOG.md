...
- Simulation
  ...
  - Fixed boxed semi-smooth Newton LCP solves with friction-index moving
    ...
    coupled friction-index 3-, 6-, 9-, 12-, and 16-contact packets, and active-set
  ...
  - Added manifest-generated serial and DART 7 `ParallelExecutor` batch LCP
    ...
    verified across default, SIMD-enabled, and CUDA-enabled build trees, plus
    15 near-singular benchmark rows for standard 8-row, boxed 8-row, and
    coupled friction-index 3-, 6-, 9-, 12-, and 16-contact packets verified across
  ...
  - Added DART 7 `dart::simulation::World` boxed-LCP snapshot coverage for one
    ...
    plus PGS-only CUDA batch coverage for homogeneous 1/4/8/16-box and grouped
