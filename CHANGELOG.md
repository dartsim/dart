...
- Core
  ...
  - Fixed DART logging with non-literal runtime format strings across supported spdlog/fmt combinations. ([#2542](https://github.com/dartsim/dart/pull/2542), [#2538](https://github.com/dartsim/dart/issues/2538))
