...
- GUI and Rendering
  ...
  - Extended experimental Filament GUI descriptor and renderer coverage to
    ...
    sphere/ellipsoid/cylinder/capsule/cone hit normals, unsupported shapes
    producing diagnostic descriptors, and backend-hidden renderable set update planning
