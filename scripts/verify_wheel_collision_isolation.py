...
FORBIDDEN_BASENAME_PATTERNS = (
    ...
    "dart-test-reference-fcl*",
    "dart-test-reference-bullet*",
    "dart-test-reference-ode*",
    ...
    "dart_test-reference-fclcomponent.cmake",
    "dart_test-reference-bulletcomponent.cmake",
    "dart_test-reference-odecomponent.cmake",
    ...
    "libdart-test-reference-fcl*",
    "libdart-test-reference-bullet*",
    "libdart-test-reference-ode*",
    "libfcl*.so*",
    "libfcl*.dylib",
    "fcl*.dll",
    "libccd*.so*",
