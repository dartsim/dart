    ...
    packet: dict[str, Any] = {
        ...
        "result": {
            ...
            "claim_boundary": (
                ...
                "nothing here is nondeterminism. The corpus row's reset "
            ...
            "limitations": [
                "The mechanism is not identified: contact history leaves "
                "result-affecting state that a state-vector write does not "
                "reset, in both contact solvers, and deactivation was ruled "
                "out by probing (nothing was asleep and disabling it "
                "changed nothing). Naming the exact carrier (contact "
                "manifold caches, warm starts, or contact ordering) is the "
                "WS3 contact-identity work this finding motivates.",
