...
CANONICAL_BENCHMARKS = {
    ...
    "free_body_energy": "bm_free_body_energy",
    "free_joint_pose": "bm_free_joint_pose",
    "articulated_energy": "bm_articulated_energy",
    "contact_stability": "bm_contact_stability",
    "constraint_stability": "bm_constraint_stability",
...
ALIASES = {
    **CANONICAL_BENCHMARKS,
    ...
    "bm_free_body_energy": "bm_free_body_energy",
    "bm_free_joint_pose": "bm_free_joint_pose",
    "bm_articulated_energy": "bm_articulated_energy",
    "bm_contact_stability": "bm_contact_stability",
    "bm_constraint_stability": "bm_constraint_stability",
