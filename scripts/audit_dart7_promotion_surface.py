...
#   * compute/execution_profile.hpp carries backend-neutral nested graph timing
#     value types. World step stage profiles expose these by value through
#     graphProfiles, so consumers need the complete audited type.
