...
.. note::
   This document pertains to the new major version, DART 7, which is currently under heavy development. Please note that this early stage version may contain bugs or other issues. If you prefer to use a more stable version, please use DART 6.13 instead.
...
If you use DART in an academic publication, please consider citing this `JOSS Paper <https://doi.org/10.21105/joss.00500>`_ [`BibTeX <https://gist.github.com/jslee02/998b8809e3ae1b7aef6ef04dd2ad5e27>`_]
