...
| Multibody  | Semi-implicit joint-space forward dynamics (default)                                | ✅ available    | `WorldOptions::multibodyOptions` or `World::setMultibodyOptions(...)`; tested by [`test_world_contact_parity.cpp`](https://github.com/dartsim/dart/blob/main/tests/unit/simulation/world/test_world_contact_parity.cpp)         |
