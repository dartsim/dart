...
class AngleAxis:
    ...
    def __init__(self) -> None_:
        ...
    @typing.overload
    def __init__(self, angle: float, axis: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float64]]) -> None_:
        ...
    @typing.overload
    def __init__(self, quaternion: Quaternion) -> None_:
        ...
    @typing.overload
    def __init__(self, rotation: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[3]], numpy.dtype[numpy.float64]]) -> None_:
        ...
    @typing.overload
    def __init__(self, other: AngleAxis) -> None_:
        ...
    ...
    def rotation(self) -> numpy.ndarray[tuple[typing.Literal[3], typing.Literal[3]], numpy.dtype[numpy.float64]]:
        ...
    def set_angle(self, angle: float) -> None_:
        ...
    def set_axis(self, axis: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float64]]) -> None_:
        ...
    def set_quaternion(self, arg0: Quaternion) -> None_:
        ...
    def set_rotation(self, arg0: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[3]], numpy.dtype[numpy.float64]]) -> None_:
        ...
...
class Isometry3:
    ...
    @staticmethod
    @typing.overload
    def __init__(*args, **kwargs) -> None_:
        ...
    @staticmethod
    def set_quaternion(*args, **kwargs) -> None_:
        ...
    @typing.overload
    def __init__(self) -> None_:
        ...
    @typing.overload
    def __init__(self, matrix: numpy.ndarray[tuple[typing.Literal[4], typing.Literal[4]], numpy.dtype[numpy.float64]]) -> None_:
        ...
    @typing.overload
    def __init__(self, rotation: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[3]], numpy.dtype[numpy.float64]], translation: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float64]]) -> None_:
        ...
    @typing.overload
    def __init__(self, other: Isometry3) -> None_:
        ...
    def __str__(self) -> str:
        ...
    ...
    def multiply(self, position: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float64]]) -> numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float64]]:
        ...
    def pretranslate(self, other: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float64]]) -> None_:
        ...
    def quaternion(self) -> ...:
        ...
    def rotation(self) -> numpy.ndarray[tuple[typing.Literal[3], typing.Literal[3]], numpy.dtype[numpy.float64]]:
        ...
    def set_identity(self) -> None_:
        ...
    def set_matrix(self, arg0: numpy.ndarray[tuple[typing.Literal[4], typing.Literal[4]], numpy.dtype[numpy.float64]]) -> None_:
        ...
    def set_rotation(self, arg0: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[3]], numpy.dtype[numpy.float64]]) -> None_:
        ...
    def set_translation(self, arg0: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float64]]) -> None_:
        ...
    def translate(self, other: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float64]]) -> None_:
        ...
    def translation(self) -> numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float64]]:
        ...
class Quaternion:
    """
    Provides a unit quaternion binding of Eigen_Quaternion<>.
    """
    @staticmethod
    ...
    def __init__(self) -> None_:
        ...
    @typing.overload
    def __init__(self, wxyz: numpy.ndarray[tuple[typing.Literal[4], typing.Literal[1]], numpy.dtype[numpy.float64]]) -> None_:
        ...
    @typing.overload
    def __init__(self, w: float, x: float, y: float, z: float) -> None_:
        ...
    @typing.overload
    def __init__(self, rotation: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[3]], numpy.dtype[numpy.float64]]) -> None_:
        ...
    @typing.overload
    def __init__(self, other: Quaternion) -> None_:
        ...
    def __str__(self) -> str:
        ...
    ...
    def set_rotation(self, arg0: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[3]], numpy.dtype[numpy.float64]]) -> None_:
        ...
    @typing.overload
    def set_wxyz(self, wxyz: numpy.ndarray[tuple[typing.Literal[4], typing.Literal[1]], numpy.dtype[numpy.float64]]) -> None_:
        ...
    @typing.overload
    def set_wxyz(self, w: float, x: float, y: float, z: float) -> None_:
        ...
    def to_rotation_matrix(self) -> numpy.ndarray[tuple[typing.Literal[3], typing.Literal[3]], numpy.dtype[numpy.float64]]:
        ...
    def w(self) -> float:
