...
class CompositeResourceRetriever(dartpy.common.ResourceRetriever):
    def __init__(self) -> None_:
        ...
    def addDefaultRetriever(self, resourceRetriever: dartpy.common.ResourceRetriever) -> None_:
        ...
...
class DartLoader:
    ...
    def __init__(self) -> None_:
        ...
    def addPackageDirectory(self, packageName: str, packageDirectory: str) -> None_:
        ...
    ...
    def parseWorldString(self, urdfString: str, baseUri: dartpy.common.Uri) -> dartpy.simulation.World:
        ...
    def setOptions(self, options: DartLoaderOptions = ...) -> None_:
        ...
class DartLoaderOptions:
    ...
    def __init__(self, resourceRetriever: dartpy.common.ResourceRetriever = None, defaultRootJointType: DartLoaderRootJointType = ..., defaultInertia: dartpy.dynamics.Inertia = ...) -> None_:
        ...
...
class PackageResourceRetriever(dartpy.common.ResourceRetriever):
    def __init__(self, localRetriever: dartpy.common.ResourceRetriever) -> None_:
        ...
    def addPackageDirectory(self, packageName: str, packageDirectory: str) -> None_:
        ...
