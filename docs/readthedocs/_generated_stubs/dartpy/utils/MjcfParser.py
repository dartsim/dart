...
class Options:
    ...
    def __init__(self, resourceRetretrieverOrNullptrriever: dartpy.common.ResourceRetriever = None, geomSkeletonNamePrefix: str = '__geom_skel__', siteSkeletonNamePrefix: str = '__site_skel__') -> None_:
        ...
