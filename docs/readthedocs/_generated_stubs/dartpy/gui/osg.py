...
class BodyNodeDnD(DragAndDrop):
    @typing.overload
    def __init__(self, viewer: Viewer, bn: dartpy.dynamics.BodyNode) -> None_:
        ...
    @typing.overload
    def __init__(self, viewer: Viewer, bn: dartpy.dynamics.BodyNode, useExternalIK: bool) -> None_:
        ...
    @typing.overload
    def __init__(self, viewer: Viewer, bn: dartpy.dynamics.BodyNode, useExternalIK: bool, useWholeBody: bool) -> None_:
        ...
    ...
    def move(self) -> None_:
        ...
    def release(self) -> None_:
        ...
    def saveState(self) -> None_:
        ...
    def setJointRestrictionModKey(self, modkey: GUIEventAdapter.ModKeyMask) -> None_:
        ...
    def setPreserveOrientationModKey(self, modkey: GUIEventAdapter.ModKeyMask) -> None_:
        ...
    def update(self) -> None_:
        ...
    def useExternalIK(self, external: bool) -> None_:
        ...
    def useWholeBody(self, wholeBody: bool) -> None_:
        ...
class CameraMode:
    """
    Members:
...
class DragAndDrop(dartpy.common.Observer, dartpy.common.Subject):
    ...
    ALWAYS_ON: typing.ClassVar[DragAndDrop.RotationOption]  # value = <RotationOption.ALWAYS_ON: 1>
    HOLD_MODKEY: typing.ClassVar[DragAndDrop.RotationOption]  # value = <RotationOption.HOLD_MODKEY: 0>
    def constrainToLine(self, slope: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float64]]) -> None_:
        ...
    def constrainToPlane(self, normal: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float64]]) -> None_:
        ...
    ...
    def saveState(self) -> None_:
        ...
    def setObstructable(self, obstructable: bool) -> None_:
        ...
    def setRotationModKey(self, rotationModKey: GUIEventAdapter.ModKeyMask) -> None_:
        ...
    def setRotationOption(self, option: ...) -> None_:
        ...
    def unconstrain(self) -> None_:
        ...
    def update(self) -> None_:
        ...
...
class GridVisual(ViewerAttachment):
    ...
    def __init__(self) -> None_:
        ...
    def setMinorLineStepSize(self, arg0: float) -> None_:
        ...
    def setNumCells(self, arg0: int) -> None_:
        ...
    def setNumMinorLinesPerMajorLine(self, arg0: int) -> None_:
        ...
    def setOffset(self, arg0: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float64]]) -> None_:
        ...
    def setPlaneType(self, arg0: ...) -> None_:
        ...
class PolyhedronVisual(ViewerAttachment):
    ...
    def clear(self) -> None_:
        ...
    def display(self, arg0: bool) -> None_:
        ...
    def displaySurface(self, arg0: bool) -> None_:
        ...
    def displayWireframe(self, arg0: bool) -> None_:
        ...
    ...
    def isWireframeDisplayed(self) -> bool:
        ...
    def setSurfaceColor(self, arg0: numpy.ndarray[tuple[typing.Literal[4], typing.Literal[1]], numpy.dtype[numpy.float64]]) -> None_:
        ...
    def setVertices(self, arg0: list[numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float64]]]) -> None_:
        ...
    def setVerticesMatrix(self, arg0: numpy.ndarray[typing.Any, numpy.dtype[numpy.float64]]) -> None_:
        ...
    def setWireframeColor(self, arg0: numpy.ndarray[tuple[typing.Literal[4], typing.Literal[1]], numpy.dtype[numpy.float64]]) -> None_:
        ...
    def setWireframeWidth(self, arg0: float) -> None_:
        ...
class ImGuiHandler:
    def __init__(self) -> None_:
        ...
    @typing.overload
    def addWidget(self, widget: ...) -> None_:
        ...
    @typing.overload
    def addWidget(self, widget: ..., visible: bool) -> None_:
        ...
    def handle(self, eventAdapter: GUIEventAdapter, actionAdapter: GUIActionAdapter, object: ..., nodeVisitor: ...) -> bool:
        ...
    def hasWidget(self, widget: ...) -> bool:
        ...
    def newFrame(self, renderInfo: ...) -> None_:
        ...
    def removeAllWidget(self) -> None_:
        ...
    def removeWidget(self, widget: ...) -> None_:
        ...
    def render(self, renderInfo: ...) -> None_:
        ...
    def setCameraCallbacks(self, camera: ...) -> None_:
        ...
class ImGuiViewer(Viewer):
    ...
    def __init__(self) -> None_:
        ...
    @typing.overload
    def __init__(self, clearColor: numpy.ndarray[tuple[typing.Literal[4], typing.Literal[1]], numpy.dtype[numpy.float64]]) -> None_:
        ...
    @typing.overload
    def __init__(self, clearColor: ...) -> None_:
        ...
    def getImGuiHandler(self) -> ImGuiHandler:
        ...
    def hideAbout(self) -> None_:
        ...
    def showAbout(self) -> None_:
        ...
class ImGuiWidget:
    def hide(self) -> None_:
        ...
    def isVisible(self) -> bool:
        ...
    def render(self) -> None_:
        ...
    def setVisible(self, visible: bool) -> None_:
        ...
    def show(self) -> None_:
        ...
    def toggleVisible(self) -> None_:
        ...
class InteractiveFrame(dartpy.dynamics.SimpleFrame):
    @typing.overload
    def __init__(self, referenceFrame: dartpy.dynamics.Frame) -> None_:
        ...
    @typing.overload
    def __init__(self, referenceFrame: dartpy.dynamics.Frame, name: str) -> None_:
        ...
    @typing.overload
    def __init__(self, referenceFrame: dartpy.dynamics.Frame, name: str, relativeTransform: dartpy.math.Isometry3) -> None_:
        ...
    @typing.overload
    def __init__(self, referenceFrame: dartpy.dynamics.Frame, name: str, relativeTransform: dartpy.math.Isometry3, sizeScale: float) -> None_:
        ...
    @typing.overload
    def __init__(self, referenceFrame: dartpy.dynamics.Frame, name: str, relativeTransform: dartpy.math.Isometry3, sizeScale: float, thicknessScale: float) -> None_:
        ...
    @typing.overload
    ...
    def removeAllShapeFrames(self) -> None_:
        ...
    @typing.overload
    def resizeStandardVisuals(self) -> None_:
        ...
    @typing.overload
    def resizeStandardVisuals(self, sizeScale: float) -> None_:
        ...
    @typing.overload
    def resizeStandardVisuals(self, sizeScale: float, thicknessScale: float) -> None_:
        ...
class InteractiveFrameDnD(DragAndDrop):
    def __init__(self, viewer: Viewer, frame: InteractiveFrame) -> None_:
        ...
    def move(self) -> None_:
        ...
    def saveState(self) -> None_:
...
class InteractiveTool(dartpy.dynamics.SimpleFrame):
    ...
    NUM_TYPES: typing.ClassVar[InteractiveTool.Type]  # value = <Type.NUM_TYPES: 3>
    PLANAR: typing.ClassVar[InteractiveTool.Type]  # value = <Type.PLANAR: 2>
    def __init__(self, frame: ..., defaultAlpha: float, name: str) -> None_:
        ...
    ...
    def removeAllShapeFrames(self) -> None_:
        ...
    def resetAlpha(self) -> None_:
        ...
    def setAlpha(self, alpha: float) -> None_:
        ...
    @typing.overload
    def setDefaultAlpha(self, alpha: float) -> None_:
        ...
    @typing.overload
    def setDefaultAlpha(self, alpha: float, reset: bool) -> None_:
        ...
    def setEnabled(self, enabled: bool) -> None_:
        ...
class RealTimeWorldNode(WorldNode):
    ...
    def __init__(self) -> None_:
        ...
    @typing.overload
    def __init__(self, world: dartpy.simulation.World) -> None_:
        ...
    @typing.overload
    def __init__(self, world: dartpy.simulation.World, shadower: ...) -> None_:
        ...
    @typing.overload
    def __init__(self, world: dartpy.simulation.World, shadower: ..., targetFrequency: float) -> None_:
        ...
    @typing.overload
    def __init__(self, world: dartpy.simulation.World, shadower: ..., targetFrequency: float, targetRealTimeFactor: float) -> None_:
        ...
    ...
    def getTargetRealTimeFactor(self) -> float:
        ...
    def refresh(self) -> None_:
        ...
    def setTargetFrequency(self, targetFrequency: float) -> None_:
        ...
    def setTargetRealTimeFactor(self, targetRTF: float) -> None_:
        ...
...
class SimpleFrameDnD(DragAndDrop):
    def __init__(self, viewer: Viewer, frame: dartpy.dynamics.SimpleFrame) -> None_:
        ...
    def move(self) -> None_:
        ...
    def saveState(self) -> None_:
...
class SimpleFrameShapeDnD(SimpleFrameDnD):
    def __init__(self, viewer: Viewer, frame: dartpy.dynamics.SimpleFrame, shape: dartpy.dynamics.Shape) -> None_:
        ...
    def update(self) -> None_:
        ...
class Viewer(osgViewer, dartpy.common.Subject):
    ...
    def __init__(self) -> None_:
        ...
    @typing.overload
    def __init__(self, clearColor: numpy.ndarray[tuple[typing.Literal[4], typing.Literal[1]], numpy.dtype[numpy.float32]]) -> None_:
        ...
    @typing.overload
    def __init__(self, clearColor: ...) -> None_:
        ...
    def addAttachment(self, attachment: ...) -> None_:
        ...
    def addInstructionText(self, instruction: str) -> None_:
        ...
    @typing.overload
    def addWorldNode(self, newWorldNode: WorldNode) -> None_:
        ...
    @typing.overload
    def addWorldNode(self, newWorldNode: WorldNode, active: bool) -> None_:
        ...
    def allowSimulation(self, allow: bool) -> None_:
        ...
    def captureScreen(self, filename: str) -> None_:
        ...
    ...
    def enableDragAndDrop(self, entity: dartpy.dynamics.Entity) -> ...:
        ...
    @typing.overload
    def frame(self) -> None_:
        ...
    @typing.overload
    def frame(self, arg0: float) -> None_:
        ...
    ...
    def isSimulating(self) -> bool:
        ...
    def pauseRecording(self) -> None_:
        ...
    @typing.overload
    def record(self, directory: str) -> None_:
        ...
    @typing.overload
    def record(self, directory: str, prefix: str) -> None_:
        ...
    @typing.overload
    def record(self, directory: str, prefix: str, restart: bool) -> None_:
        ...
    @typing.overload
    def record(self, directory: str, prefix: str, restart: bool, digits: int) -> None_:
        ...
    def removeAttachment(self, attachment: ...) -> None_:
        ...
    @typing.overload
    def removeWorldNode(self, oldWorldNode: WorldNode) -> None_:
        ...
    @typing.overload
    def removeWorldNode(self, oldWorld: dartpy.simulation.World) -> None_:
        ...
    def run(self) -> int:
        ...
    def setCameraHomePosition(self, arg0: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float64]], arg1: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float64]], arg2: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float64]]) -> None_:
        ...
    def setCameraMode(self, mode: ...) -> None_:
        ...
    def setLightingMode(self, lightingMode: ...) -> None_:
        ...
    def setUpViewInWindow(self, arg0: int, arg1: int, arg2: int, arg3: int) -> None_:
        ...
    @typing.overload
    def setUpwardsDirection(self, up: ...) -> None_:
        ...
    @typing.overload
    def setUpwardsDirection(self, up: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float64]]) -> None_:
        ...
    def setVerticalFieldOfView(self, fov: float) -> None_:
        ...
    @typing.overload
    def setWorldNodeActive(self, node: WorldNode) -> None_:
        ...
    @typing.overload
    def setWorldNodeActive(self, node: WorldNode, active: bool) -> None_:
        ...
    @typing.overload
    def setWorldNodeActive(self, world: dartpy.simulation.World) -> None_:
        ...
    @typing.overload
    def setWorldNodeActive(self, world: dartpy.simulation.World, active: bool) -> None_:
        ...
    def setupDefaultLights(self) -> None_:
        ...
    def simulate(self, on: bool) -> None_:
        ...
    def switchDefaultEventHandler(self, on: bool) -> None_:
        ...
    def switchHeadlights(self, on: bool) -> None_:
        ...
    def updateDragAndDrops(self) -> None_:
        ...
    def updateViewer(self) -> None_:
        ...
...
class WorldNode:
    ...
    def __init__(self, world: dartpy.simulation.World) -> None_:
        ...
    @typing.overload
    def __init__(self, world: dartpy.simulation.World, shadowTechnique: ...) -> None_:
        ...
    def customPostRefresh(self) -> None_:
        ...
    def customPostStep(self) -> None_:
        ...
    def customPreRefresh(self) -> None_:
        ...
    def customPreStep(self) -> None_:
        ...
    ...
    def refresh(self) -> None_:
        ...
    def setNumStepsPerCycle(self, steps: int) -> None_:
        ...
    @typing.overload
    def setShadowTechnique(self) -> None_:
        ...
    @typing.overload
    def setShadowTechnique(self, shadowTechnique: ...) -> None_:
        ...
    def setWorld(self, newWorld: dartpy.simulation.World) -> None_:
        ...
    def simulate(self, on: bool) -> None_:
        ...
...
class osgViewer:
    def __init__(self) -> None_:
        ...
    def addEventHandler(self, eventHandler: __GUIEventHandler__) -> None_:
        ...
