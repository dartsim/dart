...
| `dart-new-team-task` | `$dart-new-team-task` | `/dart-new-team-task` | `docs/ai/principles.md`, `docs/ai/north-star.md`, `docs/ai/orchestration.md`, `docs/plans/dashboard.md`, `docs/ai/verification.md`, `docs/dev_tasks/README.md` | Decision interview before large work; per-packet task-specific gates from `docs/ai/verification.md`; `pixi run lint` before commits; external mutations require explicit approval |
