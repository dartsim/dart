...
| `dart-resume` | `$dart-resume` | `/dart-resume` | active `RESUME.md`, `docs/dev_tasks/README.md`, `docs/ai/sessions.md`, `docs/ai/verification.md`, `docs/onboarding/ci-cd.md`, `docs/onboarding/contributing.md`, `docs/onboarding/changelog.md` | `git status --short --branch`; promote durable dashboards/matrices out of `docs/dev_tasks/` before task cleanup; explicit approval before push/PR update |
...
| "Draft changelog entry" | `dart-changelog` | `changelog.md`, `release-roadmap.md`, `release-management.md`, `CHANGELOG.md`, named PR/issue/release or current diff | Docs-only checks from `docs/ai/verification.md`; `pixi run lint` before commits; explicit approval before PR update/push |
...
| "Continue the task" | `dart-resume` | active `RESUME.md`, dev task, `docs/ai/sessions.md`, `docs/ai/verification.md`, CI/contributing/changelog docs | `git status --short --branch`; promote durable dashboards/matrices before dev-task cleanup; explicit approval before push/PR update |
