...
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Release direction        | `main` targets DART 7 as the clean-break line with a Python-first API; `release-6.16` remains the compatibility line for the established DART 6 API and Gazebo/gz-physics users; DART 8 is reserved for post-DART-7 cleanup rather than the active DART 6 removal point.                    | `README.md`, `docs/onboarding/release-roadmap.md`, `docs/design/dart7_clean_break_strategy.md`, `CHANGELOG.md`                                                                                 |
