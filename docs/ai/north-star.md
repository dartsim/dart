...
<!-- docs-policy: evidence-last-verified=2026-09-06 -->
...
| Core engine              | The simulation core is layered around common utilities, math/LCP, dynamics, collision, constraints, simulation, IO, GUI, SIMD, and Python bindings.                                                                                                                                                                                             | `docs/readthedocs/architecture.md`, `docs/assets/architecture/`, `docs/onboarding/architecture.md`, module `AGENTS.md` files under `dart/`                                            |
...
| Active large tasks       | World split is no longer tracked as an active dev-task folder. DART 7 World promotion now lives in PLAN-040/041/042 plus the durable API/design docs; remaining algorithm work lives in its durable plans; selected multi-session packets get focused `docs/dev_tasks/` handoffs (GUI work is owned by `docs/design/dartsim_gui_simulator.md`). | `docs/plans/dashboard.md`, `docs/plans/041-official-simulation-api-promotion.md`, `docs/plans/042-dart7-public-api-and-source-layout.md`, `docs/dev_tasks/README.md`                  |
