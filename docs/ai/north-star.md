...
| Public API modernization | DART 7 uses C++23, snake_case public headers with generated PascalCase compatibility wrappers, explicit API-boundary policy, and boundary inventory checks.                                                                                                                                         | `docs/onboarding/code-style.md`, `docs/onboarding/api-boundaries.md`, `docs/onboarding/api-boundary-inventory.md`                                                                 |
