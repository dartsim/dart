...
| Active large tasks       | Filament GUI migration has a detailed dev task and north-star migration plan. World split has design/migration notes but lacks the required `README.md` and `RESUME.md` files for an active dev task.                      | `docs/dev_tasks/filament_gui/`, `docs/dev_tasks/world_split/`, `docs/dev_tasks/README.md`                                  |
