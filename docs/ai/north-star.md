...
| Active dev-task hygiene needs continuous enforcement.                                                                                                           | Long-running work loses context when a task folder omits required status and resume files, and completed task folders confuse future planning.              | Keep DART 7 World promotion in PLAN-040/041/042 and durable design/onboarding docs; continue requiring active `docs/dev_tasks/<task>/` folders to carry `README.md` and `RESUME.md`, and delete completed folders in the same PR that completes the work. |
