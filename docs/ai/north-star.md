...
| Algorithm extensibility  | Modular foundations exist, and PLAN-091 completed the June 2026 architecture-hardening packet series for the internal solver contract, Model/State split, compute-executor axis, and apples-to-apples comparison substrate; new solver families now route through the standing intake gate.          | `docs/design/dart7_architecture_assessment.md`, `docs/plans/solver-family-intake.md`, `docs/plans/dashboard.md`                                                                   |
...
| Algorithm extension points need continued intake discipline.                                    | Researchers need to implement new algorithms and compare them against built-in baselines without rewriting foundations.                                     | PLAN-091 completed the first hardening packet series; keep the verified findings in `docs/design/dart7_architecture_assessment.md` current and route every new family through the strengthened `docs/plans/solver-family-intake.md`.                       |
