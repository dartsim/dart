...
| Active large tasks       | Active multi-session work lives in compliant `docs/dev_tasks/<task>/` folders with required status and resume surfaces. Durable state promoted out of completed task folders belongs in onboarding, design, or plan docs.                                                                   | `docs/dev_tasks/`, `docs/dev_tasks/README.md`, `docs/plans/dashboard.md`, `docs/onboarding/`                                                                                                   |
