...
| Active large tasks       | Filament GUI migration has a detailed dev task and north-star migration plan. World split has compliant dev-task status and resume files while the experimental-world split remains active.                                | `docs/dev_tasks/filament_gui/`, `docs/dev_tasks/world_split/`, `docs/dev_tasks/README.md`                                  |
