...
- Runtime mixed-domain stepping and sparse equality-constraint solving are only
  ...
  and pulley inter-body/static-rigid/moving-rigid external CCD sidecar witness
  sets, a reduced umbrella inter-body/static-rigid/moving-rigid external CCD sidecar
