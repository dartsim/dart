...
- Private GPU packets do not yet prove same-scene CPU/GPU speedups for contact
  ...
  off-diagonal pair slots, one symmetric sparse residual matvec, and sparse
  ...
  rows, and speedup remain unproven. The reduced
