...
- CPU benchmark/profile packets do not yet reproduce every paper/deck
  ...
  but other broader figure/demo scene rows still have zero external
  candidate/check/hit counts and lying-flat inter-body/moving-rigid external
  counters remain zero; accepted
