...
| `gpu-parity-packet.json` | 6         | `in-progress`: 2, `measured`: 1, `planned`: 3 |
...
| GPU packets exist for GPU claims                              | Blocked      | `gpu-parity-packet.json` has a measured PSD projection packet plus in-progress point-triangle contact-stencil and endpoint-linear point-triangle CCD/line-search parity packets, but three rows remain `planned` and no scene-level GPU speed claim exists.                                                                                                                                                                                                                                                                                                                                                                                                                        |
