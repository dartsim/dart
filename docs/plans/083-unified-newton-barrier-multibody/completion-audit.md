...
- Private GPU packets do not yet prove same-scene CPU/GPU speedups for contact
  ...
  off-diagonal pair slots, and sparse equality-reduced diagonal solves only,
  but global sparse factorization, nonlinear equality constraints, runtime
