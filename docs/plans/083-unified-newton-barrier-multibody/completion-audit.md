...
Maintainer decision (2026-07-04): the temporary
`docs/dev_tasks/unified_newton_barrier_multibody/` working folder is retired.
Remaining PLAN-083 work is owned by this audit, the plan file
[`083-unified-newton-barrier-multibody.md`](../083-unified-newton-barrier-multibody.md),
the [`dashboard.md`](../dashboard.md) PLAN-083 entry, and the plan sidecars in
this directory. PLAN-083 stays Active as a plan and remains NOT COMPLETE; the
remaining blockers below did not change, only their owner moved from the
dev-task folder to durable plan surfaces.
...
| Durable docs own landed architecture                          | Partial      | Durable plan sidecars own the manifest, CPU corpus, GPU packet, roadmap, designs, and this audit. The temporary dev-task folder is retired (2026-07-04); durable plan surfaces now own the remaining in-progress work.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| Temporary dev-task folder retired                             | Done         | Retired 2026-07-04 by maintainer decision; remaining in-progress work relocated to durable plan, dashboard, and sidecar ownership.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
Resolved (2026-07-04): the maintainer chose option 2 below - retire the
temporary dev-task folder now. The retirement change removes
`docs/dev_tasks/unified_newton_barrier_multibody/`, relocates every remaining
blocker above into durable plan/dashboard/sidecar ownership, and accepts that
PLAN-083 is still incomplete. PLAN-083 stays Active as a plan.
...
2. Retire the dev-task folder after relocating every remaining blocker above
   into durable plan/dashboard ownership and accepting that PLAN-083 is still
   incomplete.
