...
- Runtime mixed-domain stepping and sparse equality-constraint solving are only
  ...
  pulley, umbrella, and terrain vehicle inter-body/static-rigid/moving-rigid
  external CCD sidecar witness sets, a reduced Candy static-rigid/moving-rigid
  surface CCD witness pair, a reduced
