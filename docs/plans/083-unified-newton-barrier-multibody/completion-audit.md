...
- Private GPU packets do not yet prove same-scene CPU/GPU speedups for contact
  ...
  solves, and sparse equality-reduced diagonal solves only, but full runtime
  sparse Hessian
