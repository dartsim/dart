...
| ------------------------ | --------- | ---------------------------------------------------- |
| `paper-deck-manifest.md` | 48        | `in-progress`: 35, `planned`: 13                     |
...
- Runtime mixed-domain stepping and sparse equality-constraint solving are only
  ...
  reduced Table 2 setup/statistics packets, and the sparse equality
  change-of-variable rigid IPC path, but paper-scale mixed scenes plus
  analytical pulley/sliding reproductions remain unproven.
