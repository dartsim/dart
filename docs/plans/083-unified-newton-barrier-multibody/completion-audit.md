...
- Private GPU packets do not yet prove same-scene CPU/GPU speedups for contact
  ...
  Jacobi solves, capped sparse CG solves, and sparse equality-reduced diagonal
  solves only, but full runtime sparse Hessian
