...
- Next step: Continue the active
  ...
  matvec plus sparse equality-reduced diagonal solve parity, reduced hanging-bridge scene
  ...
  runtime sparse Hessian assembly, global sparse factorization, nonlinear
  equality constraints, GPU `World::step`, paper-scale assets, full runtime affine/FEM coupling, and
