...
| [`122-simulation-loop-allocation-hardening.md`](122-simulation-loop-allocation-hardening.md)                                                                         | PLAN-122 DART 7 no-allocation-after-bake closure plan                   |
| [`122-simulation-loop-allocation-hardening/coverage-matrix.md`](122-simulation-loop-allocation-hardening/coverage-matrix.md)                                         | PLAN-122 DART 7 simulation-loop allocation coverage matrix              |
| [`123-citation-driven-simulation-trust.md`](123-citation-driven-simulation-trust.md)                                                                                 | PLAN-123 citation reproduction, contact trust, and solver observability |
| [`123-citation-driven-simulation-trust/citation-claim-corpus.md`](123-citation-driven-simulation-trust/citation-claim-corpus.md)                                     | PLAN-123 row-level claim and evidence intake                            |
