...
| ------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **M1: Trustworthy rigid foundations**       | Compute decision and ownership first; then one dynamic body per example. Require both sphere and box examples, including static-plane contact where specified, general rotation, forces/torques, friction, restitution, complete checkpoints, and Python/C++ use. | CPU rigid physics and useful data/GPU seeds exist; complete state ownership, rotational correctness, isotropic friction, full CUDA contact/step execution, and portable continuation are partial. PLAN-030/080/041/042/122. | WP-040.3 accepts the entire named CPU/CUDA Float64 example, restart, lifecycle, allocation, installed-package, and visual evidence matrix.                                                                                                                                                                                                                                                 |
