...
`7657bb44353f802eed4be58bee5d6281827fd6bb4103bb87e1d64fdcc9396fba` and
...
quiet-host five-repeat Release run recorded 15.069347 ms median CPU cost per
step with 0.46% CPU CV. The schema-6 packet is stored in
...
renders pass. The same sealed benchmark recorded 13.036209 ms VBD and
15.069347 ms AVBD median CPU cost per step with 0.17% and 0.46% CPU CV. Its
0.8651x VBD/AVBD ratio is descriptive only because the methods produce
...
All three SI renders pass. The same sealed benchmark recorded 13.928065 ms SI
median CPU cost per step with 0.51% CPU CV. Its
0.9243x SI/AVBD and 1.0684x SI/VBD ratios are descriptive only. Frame 120 is
...
benchmark JSON transitively. Its median CPU costs/CVs are 15.069347 ms/0.46%
AVBD, 13.036209 ms/0.17% VBD, and 13.928065 ms/0.51% Sequential Impulse.
