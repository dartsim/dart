...
- Latest kinematic-push comparison mini-packet:
  the real workflow packet
  `/tmp/dart_capture_rigid_kinematic_push_rows_22_24_1781297545`
  ...
  pytest subset reported `7 passed`. The review index keeps
  `rigid_contact_manipulation`, `rigid_kinematic_driver`, and
  `rigid_kinematic_normal_push` adjacent. Row 24 now exposes
