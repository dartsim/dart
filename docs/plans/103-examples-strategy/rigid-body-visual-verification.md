...
| 2     | `rigid_body_modes`               | Which body mode should I choose?                                         | Selectable rigid solver          | Solver, executor, gravity scale, force magnitude, kinematic speed, dynamic height/x, static drift, kinematic path error, mode flags, force norm, step timing, and capture metrics.                                                                                                                                                                                                                                                                                                                                                                                                                                                    | `pixi run py-demo-capture -- --scene rigid_body_modes --frames 72 --width 960 --height 540 --show-ui`                | `test_rigid_body_modes_compare_dynamic_static_kinematic_semantics`, replay-control snapshot coverage, workflow ordering, panel/category coverage, capture metrics, and visual smoke capture.                                                                    | Contact-free mode semantics row; no sleep/wake or island activation API claim.                             |
