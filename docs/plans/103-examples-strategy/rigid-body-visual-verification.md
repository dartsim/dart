...
- Latest contact/kinematic-push comparison mini-packet:
  ...
  `/tmp/dart_capture_rigid_contact_kinematic_rows_22_24_1781298573`
  ...
  pytest subset reported `6 passed` for the row-22 follow-up and `7 passed`
  for the row-24 follow-up. The review index keeps
