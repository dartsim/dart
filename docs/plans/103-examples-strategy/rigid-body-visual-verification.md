...
- Latest body-mode follow-up:
  ...
  order, capture-command drift, category, and panel coverage.
- Latest multibody solver-family Replay timeline follow-up:
  ...
  timeline value/marker metadata.
