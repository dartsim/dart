...
- a private 6-DOF rigid-body block foundation:
  ...
  and bounded contact-friction tangent constructors. This is a local kernel
  foundation only; rigid contact manifold generation, articulated joints,
