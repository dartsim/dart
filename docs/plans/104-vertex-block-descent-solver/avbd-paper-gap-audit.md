...
- a private 6-DOF rigid-body block foundation:
  ...
  rows for that driver.
  This is a local kernel foundation only; rigid contact manifold generation,
  articulated joints, motors, fracture, World wiring, and soft/rigid coupling
