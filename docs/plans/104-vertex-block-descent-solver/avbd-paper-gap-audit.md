...
| DART-owned reproductions of 2D/3D demos and paper/video scenes                                     | First narrow AVBD rigid-constraint py-demo started (`avbd_rigid_fixed_joint_contact` for fixed-joint rows plus ordinary contact), and `sx_rigid_limited_joints` covers the public one-DOF joint facade path; all source demo scenes, paper figures, parameter sweeps, website demos, video/headline scenes, visual capture packets, and benchmark-linked reproductions remain missing                                                                                                                                                                                                                                                                                                                                                     | D1-D6         |
