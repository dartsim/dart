...
- a private 6-DOF rigid-body block foundation:
  ...
  focused coverage through the private serial rigid row solve.
  This is still a local foundation only; solver-stage rigid contact manifold
  use, articulated joints, motors, fracture, and soft/rigid coupling are still
  missing; and
