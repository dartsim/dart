...
- a private 6-DOF rigid-body block foundation:
  ...
  to a circular Coulomb cone. This is a local kernel foundation only; rigid
  contact manifold generation, articulated joints, motors, fracture, World
  wiring, and soft/rigid coupling are still missing; and
