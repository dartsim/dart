...
- a private 6-DOF rigid-body block foundation:
  ...
  rigid-body ECS writeback. This is still a local foundation only; solver-stage
  rigid contact activation, articulated joints, motors, fracture, and soft/rigid
  coupling are still missing; and
