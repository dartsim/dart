...
| Joint, attachment, motor, fracture, and breakable hard constraints                                 | Scalar hard point-attachment kernel and narrow World attachment wiring started; private fixed-joint row builders now cover all-axis fixed translation/orientation rows plus masked linear/angular axes for future hinge/revolute and limited-DOF configs; public articulated joint extraction, motors, fracture, and breakable constraints remain missing                                                                                                                                                                                                                                                                                                                                                                         | A5            |
