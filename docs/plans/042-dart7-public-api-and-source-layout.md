...
5. **Classic simulation and dynamics boundary.** Decide which DART 6 `World`,
   ...
   **Decision: DART 6 legacy removal staging.** The DART 7 end state is to
   ...
   refreshing the WP-091 closeout include #3071, #3086, #3092, #3105, and
   #3107, but the list is not exhaustive.
...
| `dart/io`                                                               | `io` is the model-loading front door and owns format-specific parser internals.     | Which loading APIs belong in the common path versus advanced parser-specific entry points?               |
