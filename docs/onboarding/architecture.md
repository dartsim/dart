...
the math, collision, constraint, model-loading, benchmark, and test foundations
needed to implement and compare new research algorithms.
...
DART is a well-architected research-focused physics engine with:
