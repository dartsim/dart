...
- **Examples:**
  - C++ latest published: <https://dartsim.github.io/dart/v6.16.0/>
  - Python latest published: <https://dartsim.github.io/dart/v6.16.0-py/>
...
1. **Latest release for each major line** – ensures we always have a single, well-tested reference for every supported major (currently v6.16.0 for the DART 6 line).
2. **Latest patch for active minor lines** – keeps a single patch-level build for any older minor that still receives fixes (currently v6.15.0).
...
- **Workaround:** browse the Python API at <https://dartsim.github.io/dart/v6.16.0-py/>.
...
- **Solution:** view the C++ API at <https://dartsim.github.io/dart/v6.16.0/>.
*** End Patch
