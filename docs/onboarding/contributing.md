...
- Keep legacy files in `dart/` and `python/dartpy/` using PascalCase names, but use snake_case for anything new in `dart7/`, `python/dartpy7/`, and their related test/example directories
