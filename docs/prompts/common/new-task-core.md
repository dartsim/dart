...
> **Prefer command**: Use `/dart-new-task` in Claude Code or OpenCode.
...
- Assess scope: multi-phase or multi-session? Create `docs/dev_tasks/<TASK>/` (see `docs/dev_tasks/README.md` for criteria and template).
