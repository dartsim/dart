...
**Use workflow commands instead of manual prompts.** They auto-load context and
enforce workflows. Claude Code and OpenCode use `/dart-*`; Codex uses the
generated `$dart-*` skill equivalent.

| Claude/OpenCode     | Codex               | Replaces                                                     | Defined In                                   |
| ------------------- | ------------------- | ------------------------------------------------------------ | -------------------------------------------- |
| `/dart-new-task`    | `$dart-new-task`    | [common/new-task-core.md](common/new-task-core.md)           | `.claude/commands/`, `.opencode/`, `.codex/` |
| `/dart-resume`      | `$dart-resume`      | [common/resume-task.md](common/resume-task.md)               | `.claude/commands/`, `.opencode/`, `.codex/` |
| `/dart-fix-issue`   | `$dart-fix-issue`   | [issues/new.md](issues/new.md)                               | `.claude/commands/`, `.opencode/`, `.codex/` |
| `/dart-fix-ci`      | `$dart-fix-ci`      | [common/ci-failure-fix.md](common/ci-failure-fix.md)         | `.claude/commands/`, `.opencode/`, `.codex/` |
| `/dart-review-pr`   | `$dart-review-pr`   | [common/pr-review-feedback.md](common/pr-review-feedback.md) | `.claude/commands/`, `.opencode/`, `.codex/` |
| `/dart-docs-update` | `$dart-docs-update` | [common/docs-update.md](common/docs-update.md)               | `.claude/commands/`, `.opencode/`, `.codex/` |

Works with: Claude Code (`.claude/`), OpenCode (`.opencode/`), and Codex
(`.codex/skills/` generated by `pixi run sync-ai-commands`).
