# DART: Initial Prompt Improvement
...
Rules
- Only change prompt templates in `docs/prompts/`.
- Follow `docs/prompts/CONTRIBUTING.md`.
...
3) Update `docs/prompts/AGENTS.md` index if adding/removing prompts.
