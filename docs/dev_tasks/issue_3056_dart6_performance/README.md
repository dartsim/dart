...
`perf/dart6-native-aabb-bounds`, and #3140
`perf/dart6-single-body-lcp-fast-path`. The stack is already based on current
`origin/release-6.20`, including the merged #3129 shape-cache work.
