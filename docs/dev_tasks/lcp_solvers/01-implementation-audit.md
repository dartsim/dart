...
- Current evidence is mostly math-layer evidence, with DART 7
  ...
  256-link, 384-link, 512-link, 768-link, 1024-link, 1536-link, and
  2048-link scenes,
  1-/4-/8-/16-/24-/32-/64-/96-/128-/192-/256-/384-/512-/768-/1024-/1536-/2048-link articulated ground-step
  ...
  sixty-four-, ninety-six-, 128-, 192-, 256-, 384-, 512-, 768-, 1024-, 1536-,
  and 2048-chain scenes, 1-/4-/8-/16-/24-/32-/64-/96-/128-/192-/256-/384-/512-/768-/1024-/1536-/2048-chain
  ...
  ninety-six-pair, 128-pair, 192-pair, 256-pair, 384-pair, 512-pair, and
  768-pair, 1024-pair, 1536-pair, and 2048-pair
  scenes, and
  1-/4-/8-/16-/24-/32-/64-/96-/128-/192-/256-/384-/512-/768-/1024-/1536-/2048-pair one-step plus 16-/32-/64-/96-/128-/192-/256-/384-/512-/768-/1024-/1536-/2048-pair 200-step articulated
  ...
  ninety-six-pair, 128-pair, 192-pair, 256-pair, 384-pair, 512-pair, and
  768-pair, 1024-pair, 1536-pair, and 2048-pair
  scenes, and 1-/4-/8-/16-/24-/32-/64-/96-/128-/192-/256-/384-/512-/768-/1024-/1536-/2048-pair one-step plus 16-/32-/64-/96-/128-/192-/256-/384-/512-/768-/1024-/1536-/2048-pair 200-step
...
- `test_boxed_lcp_contact --gtest_filter='BoxedLcpContact.NinetySixArticulatedPrismaticLinksGroundStepMaintainsInvariants:BoxedLcpContact.NinetySixCartesianPrismaticChainsGroundStepMaintainsInvariants:BoxedLcpContact.NinetySixArticulatedPrismaticLinksPushDynamicRigidBodies:BoxedLcpContact.NinetySixArticulatedPrismaticLinksPushArticulatedPrismaticLinks' --gtest_brief=1`
  passed 4 tests in default, SIMD-enabled, and CUDA-enabled build trees,
  extending the public boxed-LCP `World::step()` regression to 96 fixed-base
  link-ground contacts, 96 connected three-axis Cartesian-chain contacts with
  288 generalized coordinates, 96 link-vs-rigid impact contacts, and 96
  cross-multibody link-vs-link impact contacts.
- `test_boxed_lcp_contact --gtest_filter='BoxedLcpContact.OneHundredTwentyEightArticulatedPrismaticLinksGroundStepMaintainsInvariants:BoxedLcpContact.OneHundredTwentyEightCartesianPrismaticChainsGroundStepMaintainsInvariants:BoxedLcpContact.OneHundredTwentyEightArticulatedPrismaticLinksPushDynamicRigidBodies:BoxedLcpContact.OneHundredTwentyEightArticulatedPrismaticLinksPushArticulatedPrismaticLinks' --gtest_brief=1`
  passed 4 tests in default, SIMD-enabled, and CUDA-enabled build trees,
  extending the public boxed-LCP `World::step()` regression to 128 fixed-base
  link-ground contacts, 128 connected three-axis Cartesian-chain contacts with
  384 generalized coordinates, 128 link-vs-rigid impact contacts, and 128
  cross-multibody link-vs-link impact contacts.
- `test_boxed_lcp_contact --gtest_filter='BoxedLcpContact.OneHundredNinetyTwoArticulatedPrismaticLinksGroundStepMaintainsInvariants:BoxedLcpContact.OneHundredNinetyTwoCartesianPrismaticChainsGroundStepMaintainsInvariants:BoxedLcpContact.OneHundredNinetyTwoArticulatedPrismaticLinksPushDynamicRigidBodies:BoxedLcpContact.OneHundredNinetyTwoArticulatedPrismaticLinksPushArticulatedPrismaticLinks' --gtest_brief=1`
  passed 4 tests in default, SIMD-enabled, and CUDA-enabled build trees,
  extending the public boxed-LCP `World::step()` regression to 192 fixed-base
  link-ground contacts, 192 connected three-axis Cartesian-chain contacts with
  576 generalized coordinates, 192 link-vs-rigid impact contacts, and 192
  cross-multibody link-vs-link impact contacts.
- `test_boxed_lcp_contact --gtest_filter='BoxedLcpContact.TwoHundredFiftySixArticulatedPrismaticLinksGroundStepMaintainsInvariants:BoxedLcpContact.TwoHundredFiftySixCartesianPrismaticChainsGroundStepMaintainsInvariants:BoxedLcpContact.TwoHundredFiftySixArticulatedPrismaticLinksPushDynamicRigidBodies:BoxedLcpContact.TwoHundredFiftySixArticulatedPrismaticLinksPushArticulatedPrismaticLinks' --gtest_brief=1`
  passed 4 tests in default, SIMD-enabled, and CUDA-enabled build trees,
  extending the public boxed-LCP `World::step()` regression to 256 fixed-base
  link-ground contacts, 256 connected three-axis Cartesian-chain contacts with
  768 generalized coordinates, 256 link-vs-rigid impact contacts, and 256
  cross-multibody link-vs-link impact contacts.
- `test_boxed_lcp_contact --gtest_filter='BoxedLcpContact.ThreeHundredEightyFourArticulatedPrismaticLinksGroundStepMaintainsInvariants:BoxedLcpContact.ThreeHundredEightyFourCartesianPrismaticChainsGroundStepMaintainsInvariants:BoxedLcpContact.ThreeHundredEightyFourArticulatedPrismaticLinksPushDynamicRigidBodies:BoxedLcpContact.ThreeHundredEightyFourArticulatedPrismaticLinksPushArticulatedPrismaticLinks' --gtest_brief=1`
  passed 4 tests in default, SIMD-enabled, and CUDA-enabled build trees,
  extending the public boxed-LCP `World::step()` regression to 384 fixed-base
  link-ground contacts, 384 connected three-axis Cartesian-chain contacts with
  1152 generalized coordinates, 384 link-vs-rigid impact contacts, and 384
  cross-multibody link-vs-link impact contacts. The 384 link-ground and
...
- `test_boxed_lcp_contact --gtest_filter='BoxedLcpContact.FiveHundredTwelveArticulatedPrismaticLinksGroundStepMaintainsInvariants:BoxedLcpContact.FiveHundredTwelveCartesianPrismaticChainsGroundStepMaintainsInvariants:BoxedLcpContact.FiveHundredTwelveArticulatedPrismaticLinksPushDynamicRigidBodies:BoxedLcpContact.FiveHundredTwelveArticulatedPrismaticLinksPushArticulatedPrismaticLinks' --gtest_brief=1`
  ...
  cross-multibody link-vs-link impact contacts.
- `test_boxed_lcp_contact --gtest_filter='BoxedLcpContact.SevenHundredSixtyEightArticulatedPrismaticLinksGroundStepMaintainsInvariants:BoxedLcpContact.SevenHundredSixtyEightCartesianPrismaticChainsGroundStepMaintainsInvariants:BoxedLcpContact.SevenHundredSixtyEightArticulatedPrismaticLinksPushDynamicRigidBodies:BoxedLcpContact.SevenHundredSixtyEightArticulatedPrismaticLinksPushArticulatedPrismaticLinks' --gtest_brief=1`
  passed 4 tests in default, SIMD-enabled, and CUDA-enabled build trees,
  extending the public boxed-LCP `World::step()` regression to 768 fixed-base
  link-ground contacts, 768 connected three-axis Cartesian-chain contacts with
  2304 generalized coordinates, 768 link-vs-rigid impact contacts, and 768
  cross-multibody link-vs-link impact contacts.
- `test_boxed_lcp_contact --gtest_filter='BoxedLcpContact.OneThousandTwentyFourArticulatedPrismaticLinksGroundStepMaintainsInvariants:BoxedLcpContact.OneThousandTwentyFourCartesianPrismaticChainsGroundStepMaintainsInvariants:BoxedLcpContact.OneThousandTwentyFourArticulatedPrismaticLinksPushDynamicRigidBodies:BoxedLcpContact.OneThousandTwentyFourArticulatedPrismaticLinksPushArticulatedPrismaticLinks' --gtest_brief=1`
  passed 4 tests in default, SIMD-enabled, and CUDA-enabled build trees,
  extending the public boxed-LCP `World::step()` regression to 1024 fixed-base
  link-ground contacts, 1024 connected three-axis Cartesian-chain contacts with
  3072 generalized coordinates, 1024 link-vs-rigid impact contacts, and 1024
  cross-multibody link-vs-link impact contacts.
- `test_boxed_lcp_contact --gtest_filter='BoxedLcpContact.OneThousandFiveHundredThirtySixArticulatedPrismaticLinksGroundStepMaintainsInvariants:BoxedLcpContact.OneThousandFiveHundredThirtySixCartesianPrismaticChainsGroundStepMaintainsInvariants:BoxedLcpContact.OneThousandFiveHundredThirtySixArticulatedPrismaticLinksPushDynamicRigidBodies:BoxedLcpContact.OneThousandFiveHundredThirtySixArticulatedPrismaticLinksPushArticulatedPrismaticLinks' --gtest_brief=1`
  passed 4 tests in default, SIMD-enabled, and CUDA-enabled build trees,
  extending the public boxed-LCP `World::step()` regression to 1536 fixed-base
  link-ground contacts, 1536 connected three-axis Cartesian-chain contacts with
  4608 generalized coordinates, 1536 link-vs-rigid impact contacts, and 1536
  cross-multibody link-vs-link impact contacts.
- `test_boxed_lcp_contact --gtest_filter='BoxedLcpContact.TwoThousandFortyEightArticulatedPrismaticLinksGroundStepMaintainsInvariants:BoxedLcpContact.TwoThousandFortyEightCartesianPrismaticChainsGroundStepMaintainsInvariants:BoxedLcpContact.TwoThousandFortyEightArticulatedPrismaticLinksPushDynamicRigidBodies:BoxedLcpContact.TwoThousandFortyEightArticulatedPrismaticLinksPushArticulatedPrismaticLinks' --gtest_brief=1`
  passed 4 tests in default, SIMD-enabled, and CUDA-enabled build trees,
  extending the public boxed-LCP `World::step()` regression to 2048 fixed-base
  link-ground contacts, 2048 connected three-axis Cartesian-chain contacts with
  6144 generalized coordinates, 2048 link-vs-rigid impact contacts, and 2048
  cross-multibody link-vs-link impact contacts.
...
- `BM_LCP_COMPARE --benchmark_filter='^BM_LcpWorldArticulated(Ground|RigidImpact|LinkImpact|CartesianGround)Step_BoxedLcp' --benchmark_min_time=0.001s --benchmark_repetitions=1`
  ...
  `BM_LcpWorldArticulatedLinkImpactStep_BoxedLcp/{16,32,64,96,128,192,256,384,512,768,1024,1536,2048}/200`, and
  ...
  `World::collide()`, advance the public boxed-LCP `World::step()` path, and
  report end-to-end invariant counters. This is fixed-base articulated contact
...
- The focused
  ...
  6 rows, `invariant_ok=1`, and zero failures, covering link-ground 2048/200,
  link-vs-rigid 2048/1 and 2048/200, cross-link 2048/1 and 2048/200, and
  Cartesian-chain 2048/200. The 2048-row counters include
  `contact_count=2048`, ground `articulated_link_count=2048`, rigid-impact
  `min_target_velocity=0.786667`, cross-link `articulated_pair_count=2048`,
  `articulated_link_count=4096`, `articulated_dof_count=4096`,
  `min_relative_velocity=0.18`, and Cartesian-chain
  `articulated_dof_count=6144`, with `max_momentum_error=0`,
  ...
  `build_cuda_enabled=1`. The CUDA-enabled rows are CPU public-step rows in
  that build tree, not CUDA LCP kernel execution.
- `BM_LCP_COMPARE --benchmark_filter='BM_LcpArticulatedUnifiedContact' --benchmark_min_time=0.001s --benchmark_repetitions=1`
  ...
  runs reported 48 256-contact rows with `contract_ok=1`,
  `contact_count=256`, `problem_size=768`, 16 rows per articulated contact
  case, `multibody_count=256/512`, and expected backend build-state counters.
  The default, SIMD-enabled, and CUDA-enabled row summaries reported zero
  residual, complementarity, and bound-violation maxima, with 48
  `build_simd_enabled=1` or `build_cuda_enabled=1` rows in the corresponding
  backend-enabled builds.
