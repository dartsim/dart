...
- `tests/benchmark/lcpsolver/bm_lcp_compare.cpp` now registers 66 scoped dense
...
- Performance breadth: manifest benchmarks are apples-to-apples math-layer
  ...
  plus scoped dense box face-contact rows through 128 boxes for six solvers and
  PGS-only dense
