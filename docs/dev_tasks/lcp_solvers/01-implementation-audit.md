...
- `UNIT_math_lcp_math_lcp_lcp_generated_coverage` passed 21
  ...
  boxed 8-row, coupled friction-index 3-, 6-, 9-, 12-, 16-, 24-, and 32-contact,
...
- `BM_LCP_COMPARE --benchmark_list_tests | rg '^BM_LcpNearSingular/' | wc -l`
  ...
  boxed 8-row, and coupled friction-index 3-, 6-, 9-, 12-, 16-, 24-, and 32-contact packets
...
- Correctness breadth: the comparison fixtures prove known small solutions, and
  ...
  9-, 12-, 16-, 24-, and 32-contact, and larger exact
  rank-deficient
