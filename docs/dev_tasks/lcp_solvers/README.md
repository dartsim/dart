...
- [x] Added 454
      ...
      coupled friction-index 8-/12-/16-/24-/32-/48-/64-/96-contact active-set packets,
...
- Verified production active-set transition batch benchmark slice:
  ...
  reported 454 rows, and JSON benchmark checks for
  `BM_LcpProductionActiveSetTransitionBatch` reported 454 rows with
  `contract_ok=1` in the default, SIMD-enabled, and CUDA-enabled build trees.
  ...
  8-/12-/16-/24-/32-/48-/64-/96-contact active-set packets.
  The rows report `production_active_set_transition_batch=1`,
  `batch_size=4`, `problem_size=24/32/36/48/64/72/96/128/144/192/288`,
  `total_problem_size=96/128/144/192/256/288/384/512/576/768/1152`, and backend
  build-state counters. Friction-index rows also report
  `contact_count=8/12/16/24/32/48/64/96`, `total_contact_count=32/48/64/96/128/192/256/384`,
...
- Added 49 `BM_LcpExtremeActiveSetTransition` rows for the scoped scalable
  ...
  CUDA-enabled rows are CPU solver rows in a CUDA-enabled build, not CUDA LCP
  kernel execution.
- Added 80 `BM_LcpProductionActiveSetTransition` rows for stronger-coupled
  24-contact, 72-row, 32-contact, 96-row, 48-contact, 144-row, and
  64-contact, 192-row, and 96-contact, 288-row
  ...
  `production_active_set_transition=1`, `contact_count=24/32/48/64/96`,
  `problem_size=72/96/144/192/288`, `coupling_scale=2/4/8/16/32`, backend build-state counters,
...
- Added 454
  ...
  8-/12-/16-/24-/32-/48-/64-/96-contact active-set packets. These rows
  report `contract_ok=1`, `production_active_set_transition_batch=1`,
  `batch_size=4`, `problem_size=24/32/36/48/64/72/96/128/144/192/288`,
  `total_problem_size=96/128/144/192/256/288/384/512/576/768/1152`, backend build-state
  counters, and parallel execution counters on the `ParallelExecutor` rows.
  Friction-index rows also report `contact_count=8/12/16/24/32/48/64/96`,
