...
- [x] Enforced owner-local name uniqueness for experimental world multibodies
      and multibody links/joints, with autogenerated names skipping collisions
      and cross-multibody parent links rejected at construction time.
...
1. Validate and push the owner-local name uniqueness slice.
