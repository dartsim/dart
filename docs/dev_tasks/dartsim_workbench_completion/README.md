...
2. Continue viewport workflow controls with multi-view layout state after the
   single-view camera mode, tracking, and layer-filter workflow settles.
