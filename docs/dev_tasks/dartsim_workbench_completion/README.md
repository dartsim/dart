...
- [ ] Phase 5: Add viewport controls, visibility filters, camera presets,
      ...
      layout through tested editor actions.
...
2. Continue Phase 5 by adding visible pane labels/status affordances and richer
   per-pane interaction polish for the renderer-side four-view layout.
