...
| Open/publish maintainer review with DART 7.0 milestone.                                          | `gh pr list --head "$(git branch --show-current)"` and `gh pr status` still return no PR after the latest approved push through `16d4032c1e2`. The explicit push request covered publishing the branch only, not PR creation, milestone mutation, CI rerun, or review-thread mutation.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | PR/milestone external action still missing    |
...
- Current remote publication state: origin branch is pushed through
  `16d4032c1e2`; later local continuation commits may be unpublished.
...
- Shared-state safety: the branch push through `16d4032c1e2` was explicitly
