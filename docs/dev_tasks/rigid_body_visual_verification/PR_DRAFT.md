...
- Adds a front-door `Focus axis` to every numbered workflow row, naming the
  main comparison or debugging dimension before users open a scene, and makes
  those axis labels searchable.
