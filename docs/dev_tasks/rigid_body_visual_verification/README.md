...
- Current continuation started with the branch clean at
  ...
  PLAN-103's rigid sidecar, this file, and `RESUME.md`.
...
2. Expect the latest completed local implementation commit to be
   `Add rigid workflow guidance to capture manifests` if this slice has been
   committed; otherwise inspect the uncommitted diff for the same
   direct-manifest workflow-guidance follow-up.
