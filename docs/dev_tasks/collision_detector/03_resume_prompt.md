...
- Raycast tests include rotated box inside hits.
...
- No new test runs yet after updating the test suite to use the built-in detector.
...
- Re-run `pixi run -e gazebo test-gz` after the test updates and update task docs.
