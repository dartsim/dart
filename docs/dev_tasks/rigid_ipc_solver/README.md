...
- [ ] Phase 4: lagged smoothed friction and friction diagnostics.
  ...
  - [x] Add exact upstream 3D spolling-coin friction fixture coverage for
        ...
        evidence.
  - [x] Add exact upstream moderate/high-friction turntable fixture coverage for
        ...
        and `mu=0.1` turntable rows remain planned.
...
- [ ] Phase 6: complete the manifest rows as DART-native tests, examples,
  ...
  - [x] Mark the audited 3D spolling-coin friction fixture row
        ...
        remains planned.
  - [x] Mark the audited moderate/high-friction 3D turntable fixture rows
        (`fixtures/3D/friction/turntable/turntable-mu=0.5.json` and
        `fixtures/3D/friction/turntable/turntable-mu=1.0.json`) as implemented
        after exact rotating-cylinder friction coverage landed. The `mu=0`,
        `mu=0.1`, and Fig. 13 paper visual aliases remain planned.
...
- The direct CCD tests now include first upstream-style edge-vertex, edge-edge,
  ...
  headless visual evidence. The moderate/high-friction `mu=0.5` and `mu=1.0`
  turntable fixture rows are marked implemented through rotating-cylinder drag
  coverage, while the `mu=0`, `mu=0.1`, and Fig. 13 visual aliases remain
  planned. The `mu=0.5` threshold rows remain planned because they still need
