...
| 10-level card house | Construction and partial reconstructed evidence only | Full exact trajectory, physical outcome, and current-build media or a precise blocker |
