...
The demo build, eight focused author-card C++ tests, 213 visual-runner Python
...
- visual-runner Python tests with the source-selected correction and
  inner-initialization contract: 213/213;
