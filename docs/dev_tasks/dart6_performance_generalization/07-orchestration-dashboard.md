...
| --- | --- | --- | --- |
| WS-A constraint/LCP | 02-constraint-lcp-lane.md | PG.10–PG.15 | active/gated (PG.10 #3339; PG.13 evidence-gated by PG.10 census; PG.14 claimed as D3 opt-in matrix-free path; PG.15 done #3353) |
...
| WP-PG.14 matrix-free path | WS-A | claimed — D3 opt-in solver option | `wp-pg-14-matrix-free-lcp` | Local artifact `/tmp/wp_pg14_matrix_free_ab_20260709T040443Z`: option-off S1 120 DART median avg-step 7.404 ms, hash `0x123ee9779bccacfb`; option-on 30-iter matrix-free median avg-step 0.663 ms, finite, hash `0xbf538ac9d35f145e`; option-on S3 active-3k fallback preserved hash `0xcf0ba6eaa97be038`. Profile: dense primary solve 77.1% of wall; matrix-free scope 17.8%, mean 781.9 rows and 1.90 iterations, 198/200 converged samples. `lint`, `check-lint`, focused/full `test_ConstraintSolver`, dartpy constraint pytest, capped `ALL`, and `test-gz` passed. |
