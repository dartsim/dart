...
| WS-B ODE backend | 03-ode-backend-lane.md | PG.20–PG.23 | open (PG.20 #3329; PG.21 re-scope after PG.20; PG.22 local cpp-only route rejected; PG.23 blocked D8; lane re-review at WS-F phase 5) |
...
| WP-PG.21 history map/pruning | WS-B | open | — | Re-scope after #3329; pair-keyed history map and current-frame pruning sweep are already included in WP-PG.20 |
