...
test_selection:
  component_mapping:
    dart/dynamics:
      ["unit/dynamics", "integration/dynamics", "benchmark/dynamics"]
    dart/collision:
      ["unit/collision", "integration/collision", "benchmark/collision"]
...
_Phase 3 will transform DART into a truly AI-native codebase where agents can work autonomously on complex robotics challenges with minimal human oversight._
