...
| Biped push recovery | Same SIMBICON-style controller with rigid contact vs soft contact; soft contact withstands larger perturbations and motor noise while maintaining more ground contact points. | PR #3408 adds the soft-foot SIMBICON regression. **Contact spreading reproduces** (52.0 soft vs 44.4 rigid over the settled window, with the models normalized to equal mass and one collision surface per foot). **Push recovery does not reproduce**: soft 4000 N vs rigid 8000 N. A stiffness sweep shows the shipped `atlas_v3_no_head_soft_feet.sdf` feet (kv 5e4, damp 1e3) are too compliant for a 147 kg Atlas; at kv 1e6 / damp 5e3 the soft feet recover 12000 N and do beat rigid. | Maintainer decision needed on retuning the shared soft-feet asset or overriding stiffness scene-locally, then re-assert the push comparison. Motor-noise variant still unbuilt. Owner: WP-DB.03, WP-DB.08, WP-DB.09. |
