...
| Biped push recovery | Same SIMBICON-style controller with rigid contact vs soft contact; soft contact withstands larger perturbations and motor noise while maintaining more ground contact points. | PR #3408 added the soft-foot SIMBICON regression with the models normalized to equal mass, one foot collision surface, and the same rest-pose collision tessellation; the follow-up matched the control's rest inertia (the unmatched tensor was worth 4000 N of its threshold) and retuned the asset's under-damped feet (<damp> 1000 -> 4000, kv unchanged, chosen from the interior of a measured 18000 N basin). **Both claims reproduce and are gate-asserted**: contacts 51.4 soft vs 15.64 rigid (3.3x, enforced at 1.5x); recoverable push 18000 N soft vs 8000 N rigid (soft >= rigid). | Both decisions resolved 2026-08-01 with A/B evidence in `12-pr3a-soft-foot-simbicon.md` § Resolved decisions; the push comparison is re-asserted. Motor-noise variant still unbuilt. Owner: WP-DB.03, WP-DB.08, WP-DB.09. |
