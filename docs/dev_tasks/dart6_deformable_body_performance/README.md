...
- `tests/integration/test_SoftDynamics.cpp` contains an equations-of-motion
  ...
  four-thread runs. WP-DB.04 now also adds an active point-mass gravity and
  combined-vector aggregation sub-gate, recorded in
