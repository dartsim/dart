...
- `tests/integration/test_SoftDynamics.cpp` contains an equations-of-motion
  ...
  combined-vector/external-force sub-gate, recorded in
  `07-equation-correctness.md`; the broader matrix/vector equation checks
  remain open.
