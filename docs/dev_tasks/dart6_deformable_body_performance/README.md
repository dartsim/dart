...
- `tests/integration/test_SoftDynamics.cpp` contains an equations-of-motion
  ...
  four-thread runs. WP-DB.04 now also adds an active point-mass gravity
  aggregation sub-gate, recorded in `07-equation-correctness.md`; the broader
  matrix/vector equation checks remain open.
