...
- WP-DB.06 scalar/cache optimization keeps public `SoftBodyNode` and
  ...
  articulated-inertia scalar formula. Current checksums stay stable, but timing
  remains too noisy for a hard speedup threshold. The branch is now stacked on
