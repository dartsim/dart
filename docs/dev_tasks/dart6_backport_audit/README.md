...
| [#2233](https://github.com/dartsim/dart/pull/2233) | compat-critical bug | URDF multidof joint limits + vector-form `GenericJoint` setters | Backported by [#3134](https://github.com/dartsim/dart/pull/3134) | Parser surface (gz gate complete) |
