...
| Raycast edge cases                     | Partial     | Grazing sphere + thin slab + near-parallel plane added; inside-origin TBD. |
...
1. Finish remaining distance/raycast edge-case regimes (inside-origin, thin-feature degenerates).
