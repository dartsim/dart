...
and explicit visual material colors. It also checks unsupported-shape
diagnostics, non-finite visual material diagnostics, and non-finite joint
...
coverage beyond material colors/link gravity mode/passive joint dynamics or
