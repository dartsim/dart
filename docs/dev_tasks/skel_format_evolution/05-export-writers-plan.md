...
extension. The SDF-specific helper surface has been narrowed accordingly: it no
longer exposes generic XML attribute, string, vector2/vectorX, or child
enumerator APIs that duplicate sdformat traversal/parsing.
