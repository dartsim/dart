...
local joint/shape poses, box/sphere/cylinder/mesh visual or collision geometry,
and explicit visual material colors as SDF `<diffuse>` values. Unsupported
constructs, non-finite material colors, and non-finite joint dynamics return
