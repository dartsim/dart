...
convex-convex batch, convex-mesh, mesh, default-world, and Atlas foot-ground
regression coverage, rebuilds `hello_world` without the OctoMap `<ciso646>`
warning, and refreshes the focused native/reference/benchmark validation
evidence in `03-evidence-gates.md`.
