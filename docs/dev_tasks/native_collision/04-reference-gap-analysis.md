...
13. Done in working tree: top-level source-tree FCL, Bullet, and ODE
...
14. Continue final CI, downstream migration, broader benchmark guardrail, and
    runtime backend deletion validation.
