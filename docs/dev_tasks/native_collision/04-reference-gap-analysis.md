...
13. Continue legacy backend abstraction cleanup for legacy detector classes,
    headers, component names, reference-only source placement, and final
...
- [ ] Legacy detector classes, headers, component names, and old-engine source
