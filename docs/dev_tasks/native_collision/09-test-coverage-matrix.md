...
- **§3 Stress / regression:** 24 DONE, 1 PARTIAL, 6 GAP (of 31 rows)
- **§4 Benchmarks:** 30 DONE, 0 PARTIAL, 14 GAP (of 44 rows)
- **§5 Infrastructure:** 9 DONE, 0 PARTIAL, 0 GAP (of 9 rows)
- **TOTAL:** 190 DONE, 1 PARTIAL, 31 GAP (of 222 rows)

DART native is currently at ~86% of the proposed superset, with pair-wise
