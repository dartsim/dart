...
- **Filament gap:** Filament does not provide DART object picking semantics.
  ...
  sphere/ellipsoid/cylinder/capsule/cone/pyramid intersections for curved hit
  points and normals. This is sufficient for an MVP but not precise enough for all
  promoted tools.
