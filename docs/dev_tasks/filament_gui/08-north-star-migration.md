...
- **Filament gap:** Filament does not provide DART object picking semantics.
  ...
  sphere/ellipsoid/cylinder/capsule/cone/pyramid plus finite plane-proxy
  intersections for surface hit points and normals. This is sufficient for an MVP
  but not precise enough for all
  promoted tools.
