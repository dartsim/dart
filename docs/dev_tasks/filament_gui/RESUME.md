...
visuals, and generated `HeightmapShape` terrain. The MVP scene now includes
pyramid, multi-sphere, line-segment, convex-mesh, point-cloud, and heightmap
fixtures, and the example startup checks that all six
