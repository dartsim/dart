...
and primitive sphere/ellipsoid/cylinder/capsule/cone surface hit points/normals.
The example wires those helpers into basic click-to-select highlighting with a
...
also use primitive sphere/ellipsoid/cylinder/capsule/cone intersections for
curved surface hit points and normals before falling back to local bounds for other
shape descriptors.
