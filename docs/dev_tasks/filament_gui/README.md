...
- The example renderer consumes box, sphere, ellipsoid, cylinder, cone,
  ...
  point-cloud, heightmap, soft-mesh, TriMesh-backed `MeshShape`, and finite
  `PlaneShape` descriptors, and applies DART visual-aspect shadow flags to
  Filament renderables.
