...
| Provide debug overlays for physics state.                                                | Grid, world/body frames, centers of mass, contacts, normals, force vectors, support-polygon outlines, support-centroid markers, and selection bounds are generated as debug descriptors. The Filament example renders debug descriptors through transparent line materials, and the G1 scene exposes active foot support geometry for the support-polygon overlay.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | Satisfied for MVP coverage; broader scenario coverage remains.                        |
