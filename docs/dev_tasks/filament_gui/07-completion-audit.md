...
| Provide renderer-hidden scene extraction.                                                | `dart/gui/experimental/scene.hpp` and `.cpp` expose renderable descriptors without Filament types; `UNIT_gui_FilamentSceneExtraction` covers the path, including diagnostic descriptors for unsupported shapes.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | Satisfied for the constrained experimental API.                                       |
