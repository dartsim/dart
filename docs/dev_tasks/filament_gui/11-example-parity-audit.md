...
| OSG shadow toggle and depth mode toggles.                                                                                       | Public API gap.                      | These need renderer-neutral render-mode concepts before exact parity; do not revive OSG or private Filament hooks in the example source. |
...
| `imgui`                     | Restored except public render-hook API gaps.                                                                                                                                             | Keep marker guards for target frame, keydown/key-release callbacks, gravity/headlight controls, camera readout/defaults, help text, README, and no backend types.                                                                                                                                                                     |
