...
| `atlas_simbicon`            | Restored except render-settings API gaps.                                                                                                                                                | Keep marker guards for controller/state files, pre-step control, perturbation and stride controls, native window title, camera/defaults, README, and no OSG types.                                                                                                                                                                    |
...
| `hubo_puppet`               | Restored by strict re-open except balance/key-state/debug-color gaps.                                                                                                                    | Keep marker guards for load/start pose, target toggles, support actions, support overlay, camera/defaults, README, and no backend types.                                                                                                                                                                                              |
...
| `imgui`                     | Restored except public headlight/camera-inspection/key-release/render-hook API gaps.                                                                                                     | Keep marker guards for target frame, keydown callbacks, gravity control, help text, camera/defaults, README, and no backend types.                                                                                                                                                                                                    |
...
| `operational_space_control` | Restored by strict re-open except shadow-toggle API gap.                                                                                                                                 | Keep marker guards for KR5 robot/ground, target ball, 1/2/3 axis aliases, defaults, camera, README, instructions, and no WAM/private-scene drift.                                                                                                                                                                                     |
