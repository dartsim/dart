...
color-edit widgets through public `PanelBuilder::colorEdit`; the remaining
gap is fine-grained debug-grid controls. Backend-specific ImGui, OSG, and
...
| `heightmap`                 | Restored except public debug-grid API gap.                                                                                                                                               | Keep OSG grid style controls tracked as public API follow-up; terrain color editing is restored through `PanelBuilder::colorEdit`.                                                                                                                                                                                                    |
...
| `point_cloud`               | Restored except public debug-grid API gap.                                                                                                                                               | Keep fine-grained grid controls tracked as a public API follow-up; point-cloud and voxel-grid color editors are restored through `PanelBuilder::colorEdit`.                                                                                                                                                                           |
