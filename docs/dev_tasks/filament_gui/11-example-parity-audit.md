...
| `box_stacking`              | Restored by strict re-open except headlight/key-release viewer API gaps.                                                                                                                 | Keep marker guards for stack placement, floor geometry, solver/gravity controls, panel text, camera readout/defaults, README, and no backend types; keep headlight and key-release gaps explicit.                                                                                                                                     |
...
| `imgui`                     | Restored except public headlight/key-release/render-hook API gaps.                                                                                                                       | Keep marker guards for target frame, keydown callbacks, gravity control, camera readout/defaults, help text, README, and no backend types.                                                                                                                                                                                            |
