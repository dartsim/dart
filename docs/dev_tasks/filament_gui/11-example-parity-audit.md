...
source-owned posture/balance recovery. The remaining named gaps are analytical
IK parity and Shift movement amplification through a modifier/key-state API.
...
| README documents kinematic mode, support polygon, keyboard controls, build/run instructions.           | Restored.                                 | README was restored with promoted `dart::gui` wording and named Shift modifier plus analytical IK follow-ups.                                  |
...
| `hubo_puppet`               | Restored by strict re-open except analytical IK and Shift modifier gaps.                                                                             | Keep marker guards for load/start pose, target toggles, R balance controls, support actions, support polygon/centroid/COM overlays, camera/defaults, README, and no backend types.                                                                                                                                                    |
