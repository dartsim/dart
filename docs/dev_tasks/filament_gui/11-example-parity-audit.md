...
| `fetch`                     | Active strict re-open cursor after WAM IKFast.                                    | Re-check historical target manipulation, panel/help behavior, camera/defaults, README, capture, and marker guards before calling it complete.                                                                                                                                                                                         |
