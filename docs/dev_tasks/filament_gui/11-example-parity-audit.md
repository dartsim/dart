...
| `vehicle`                   | Active strict re-open cursor after Tinkertoy.                                     | Re-check historical command behavior, controller setup, camera/defaults, README, capture, and marker guards against `520993d7301^:examples/vehicle` before calling it complete.                                                                                                                                                       |
