...
| `atlas_puppet`              | Restored except target-activation/posture/balance/support-visualization gaps; R24-1 adds render-only public `dart::gui::Gizmo` affordances. | Keep remaining gaps explicit until repaired through source-owned state or public debug/IK APIs, and replace the old sphere affordance once gizmo handle dragging lands.                                                                                                                                                               |
