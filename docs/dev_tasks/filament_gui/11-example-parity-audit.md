...
plot through public `PanelBuilder::plotLines`. Display/font debug metrics
remain a backend-debug API gap.
...
| Preserve performance/debug information: FPS, contacts, body count, step-time plot, ImGui display/font metrics.  | Restored except backend debug metrics.    | Render FPS, rendered/skipped frames, contacts, body count, step-time summary, and step-time plot are shown now. ImGui-specific display/font metrics still need public backend-debug APIs. |
...
| Keep marker coverage for scene counts, solver/scenario controls, panel controls, README, and no backend types.  | Restored for this slice.                  | Marker guards now cover scene counts/names, live controls, README options, capture flags, step-time plotting, backend-debug gap text, and absence of legacy launcher.                     |
...
| `lcp_physics`               | Restored by strict re-open except backend-debug API gap.                                                                                             | Keep marker guards for historical scene counts/names/placements, live solver/scenario/reset/timestep/gravity panel controls, FPS/step-time diagnostics and plot, README options, capture flags, and no backend types.                                                                                                                 |
