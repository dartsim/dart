...
- `pixi run test-filament-gui-smoke` passed locally with the same explicit
  ...
  lcp-physics, mimic-pendulums, atlas-puppet, operational-space-control,
  drag-and-drop,
