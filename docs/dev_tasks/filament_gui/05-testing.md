...
- `pixi run test-filament-gui-smoke` passed locally with the same explicit
  ...
  rigid-loop, mixed-chain, coupler-constraint, add-delete-skels, drag-and-drop,
