...
- `UNIT_gui_FilamentSceneExtraction` builds and passes. It covers the
  ...
  points/normals including primitive sphere/ellipsoid/cylinder/capsule surface
  hits, renderable set update planning, and debug-line descriptors, without
...
- Renderer-independent nearest-hit picking is unit-tested for visible, hidden,
  hit, miss, bounds-normal, and primitive sphere/ellipsoid/cylinder/capsule
