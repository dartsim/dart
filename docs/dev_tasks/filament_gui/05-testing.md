...
- `pixi run test-filament-gui-smoke` passed locally with the same explicit
  ...
  rigid-loop, mixed-chain, drag-and-drop, simple-frames, soft-bodies, point-cloud,
