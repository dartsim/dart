...
2. **Completed: move scene fixtures under private GUI detail.**
   ...
   simulation-event-handler, polyhedron, heightmap, and G1 DART world
   fixtures. The `biped_stand` runner reuses the hybrid-dynamics fullbody
   fixture rather than adding duplicate scene code.
