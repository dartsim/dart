...
2. **Completed: move scene fixtures under private GUI detail.**
   ...
   option parsing plus MVP, drag-and-drop, polyhedron, heightmap, and G1 DART
   world fixtures.
   ...
   minimal entry point.
   `dart/gui/experimental/detail/filament/scene_requirements.hpp` and `.cpp`
   now own scene fixture requirement counting and MVP/G1/drag/polyhedron/
   heightmap validation gates.
