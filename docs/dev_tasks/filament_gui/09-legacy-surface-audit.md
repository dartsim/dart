...
`mixed_chain`, `coupler_constraint`, `drag_and_drop`, `empty`,
...
default while their standalone sources remain as legacy OSG comparison material
until the promoted API can replace the missing panel/tool-specific workflows.
