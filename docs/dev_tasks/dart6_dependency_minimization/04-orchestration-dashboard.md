...
- **#3123** Speed up DART primitive plane collision (merged 2026-06-22) — dependency-free
  primitive plane contacts + finite-shape broadphase pruning. **First piece** of the native
  collision port (the FCL/Bullet/ODE-reduction lever); not yet the FCL-optional default-flip.
