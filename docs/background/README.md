...
| DART 7 references         | [`docs/readthedocs/papers.md`](../readthedocs/papers.md)                               | Research paper/textbook/engine catalog for the DART 7 simulation world (status, priority, verdict) |
