...
| PLAN-104 VBD rigid path                   | Rigid               | Fixed-penalty VBD contact and public pair-constraint projection | none                                           | explicit experimental `RigidBodySolver::Vbd` family; CPU scope remains bounded  |
| PLAN-104 AVBD rigid path                  | Rigid               | Augmented VBD contact and public pair-constraint projection     | none                                           | explicit experimental `RigidBodySolver::Avbd` family; CPU scope remains bounded |
