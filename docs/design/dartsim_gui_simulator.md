...
`docs/plans/dashboard.md` (PLAN-090); the landed developer overview lives in
...
remaining follow-ups live in `docs/plans/dashboard.md` (PLAN-090) and
`docs/plans/090-dartsim-gui-simulator.md`. At a high level:
