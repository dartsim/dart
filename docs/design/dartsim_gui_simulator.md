...
`docs/plans/dashboard.md` (PLAN-080); the landed developer overview lives in
...
remaining follow-ups live in `docs/plans/dashboard.md` (PLAN-080) and
`docs/plans/080-dartsim-gui-simulator.md`. At a high level:
