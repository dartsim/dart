...
| [`differentiable_simulation.md`](differentiable_simulation.md)                   | Opt-in analytic differentiable-simulation architecture and public API (the Nimble LCP-gradient method) for the experimental `World`      |
