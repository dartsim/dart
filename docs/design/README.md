...
| [`dart7_world_namespace_transaction.md`](dart7_world_namespace_transaction.md)   | Transaction to clear the classic `dart::simulation::World` name collision (PLAN-041 workstream 4): occupancy map, option (a) vs (b), recommended atomic swap, and the `dartpy.World` decision |
