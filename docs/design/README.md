...
| [`dart6_collision_backend_consolidation.md`](dart6_collision_backend_consolidation.md) | Canonical DART-owned detector identity, DART 6.20 compatibility boundary, downstream gz obligations, and later backend-facade lifecycle. |
