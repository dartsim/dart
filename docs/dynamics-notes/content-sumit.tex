...
For a system with only rotational DOFs, it is sufficient to invert
...
smaller constant-sized matrices $\hat{J}_{\omega k}$.
...
$\vc{v} = J_v \dot{\vc{q}}$. \sumit{not clear to me still}.
