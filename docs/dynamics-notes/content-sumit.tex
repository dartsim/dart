...
physics-based animation by Baraff and Witkin, you can stop reading
further right now. Go look for those notes at
http://www.cs.cmu.edu/~baraff/sigcourse/ and come back when
...
read Baraff and Witkin's SIGGRAPH course notes a few times but don't
...
human skeleton is consist of a collection of particles
