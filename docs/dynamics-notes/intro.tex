...
you fully understand everything in those notes.
...
likely that you do not need to understand how the underlying simulation
...
\item I have seen the Euler-Lagrange equation in the following form before, but I
...
\item I heard that inverse dynamics can be computed efficiently using
  a recursive formulation. How does that work?
\end{itemize}
