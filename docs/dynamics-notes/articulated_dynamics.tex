...
=======
We start with deriving the relation for the angular velocity. The
angular velocity (in skew-symmetric matrix form) of link $k$ viewed in the world frame is:
>>>>>>> karen
\begin{eqnarray}
\nonumber
...
Using a property of skew symmetric matrices, $[R \bm{\omega}] = R [\bm{\omega}]
R^T$, we can express \eqnref{angvelk_recursive} in vector form as:
\begin{eqnarray}
