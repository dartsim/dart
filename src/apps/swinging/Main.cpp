...
int main(int argc, char* argv[]) {
	...
	// Load the motion of the skeleton
	FileInfoDof *motion = new FileInfoDof(&LowerBodySkel);
	motion->loadFile(DART_DATA_PATH"/dof/swinging.dof");

	// OpenGL Visualization
	MyWindow window(motion, (dynamics::SkeletonDynamics*) GroundSkel.getSkel(), &LowerBodySkel, NULL);
