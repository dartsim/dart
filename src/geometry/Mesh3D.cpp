...
namespace geometry {
    ...
    bool Mesh3D::readMesh(const char *_file, MeshFormat _format){
        bool success = true;
        ...
        if(_format==OFF){
            ...
            cout<<"Mesh3D: Only triangle meshes can read CORNERTABLE format\n";
            success = false;
        }
        inFile.close();
    ...
    bool Mesh3D::writeMesh(const char *_file, MeshFormat _format){
        bool success = false;
        ...
        if(_format==OFF){
            ...
            // write header
            outFile<<"# OBJ FILE Generated by Mesh3D::writeMesh()\n";
            ...
            cout<<"Mesh3D: Only triangle meshes can write CORNERTABLE format\n";
            success = false;
        }
        outFile.close();
