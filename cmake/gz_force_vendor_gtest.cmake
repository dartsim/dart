# Ensure Gazebo downstream test targets compile against the vendored GoogleTest
# headers that match the vendored gtest static library built in
# `test/gtest_vendor`.
#
...
# Gazebo's vendored headers, the build can fail at link time due to mismatched
# internal symbols (e.g., `MakeAndRegisterTestInfo(std::string, ...)`).

set(_gz_vendor_gtest_include "${CMAKE_SOURCE_DIR}/test/gtest_vendor/include")
if(EXISTS "${_gz_vendor_gtest_include}/gtest/gtest.h")
  ...
  if(NOT EXISTS "${_gtest_include_overlay}/gtest/gtest.h")
    ...
    file(
      COPY "${_gz_vendor_gtest_include}/gtest"
