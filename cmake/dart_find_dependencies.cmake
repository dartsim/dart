...
# spdlog is optional for core DART but hard-required by the experimental module.
# dart_find_spdlog.cmake carries a FetchContent fallback that vendors spdlog when
# no system package exists; only route through it when the experimental module is
# enabled, so core-only and offline configures keep the original quiet optional
# behavior and never trigger an unexpected download. When experimental is off,
# probe directly and let core build with DART_HAVE_spdlog=0 if spdlog is absent.
