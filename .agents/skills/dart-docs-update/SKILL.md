...
3. For AI workflow changes, edit `.claude/` sources and run `pixi run sync-ai-commands`; do not hand-edit generated `.agents/skills/` files (`.codex/` is a maintained source)
