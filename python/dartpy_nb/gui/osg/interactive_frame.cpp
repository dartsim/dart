...
void defInteractiveFrame(nb::module_& m)
{
  ...
  auto it = nb::class_<InteractiveTool, dart::dynamics::SimpleFrame>(
                m, "InteractiveTool")
                .def(
                ...
                .def("removeAllShapeFrames", &InteractiveTool::removeAllShapeFrames);
  ...
  nb::class_<InteractiveFrame, dart::dynamics::SimpleFrame>(m, "InteractiveFrame")
