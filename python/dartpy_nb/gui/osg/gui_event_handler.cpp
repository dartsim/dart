...
void defGuiEventHandler(nb::module_& m)
{
  ...
  nb::enum_<osgGA::GUIEventAdapter::MouseButtonMask>(ea, "MouseButtonMask")
      .value("LEFT_MOUSE_BUTTON", osgGA::GUIEventAdapter::MouseButtonMask::LEFT_MOUSE_BUTTON)
      .value("MIDDLE_MOUSE_BUTTON", osgGA::GUIEventAdapter::MouseButtonMask::MIDDLE_MOUSE_BUTTON)
      .value("RIGHT_MOUSE_BUTTON", osgGA::GUIEventAdapter::MouseButtonMask::RIGHT_MOUSE_BUTTON)
      .export_values();
  ...
  nb::enum_<osgGA::GUIEventAdapter::EventType>(ea, "EventType")
      ...
      .value("PEN_ORIENTATION", osgGA::GUIEventAdapter::EventType::PEN_ORIENTATION)
      .value("PEN_PROXIMITY_ENTER", osgGA::GUIEventAdapter::EventType::PEN_PROXIMITY_ENTER)
      .value("PEN_PROXIMITY_LEAVE", osgGA::GUIEventAdapter::EventType::PEN_PROXIMITY_LEAVE)
      .value("CLOSE_WINDOW", osgGA::GUIEventAdapter::EventType::CLOSE_WINDOW)
      .value("QUIT_APPLICATION", osgGA::GUIEventAdapter::EventType::QUIT_APPLICATION)
  ...
  nb::enum_<osgGA::GUIEventAdapter::KeySymbol>(ea, "KeySymbol")
      ...
      .value("KEY_Rightparen", osgGA::GUIEventAdapter::KeySymbol::KEY_Rightparen)
      ...
      .value("KEY_Leftbracket", osgGA::GUIEventAdapter::KeySymbol::KEY_Leftbracket)
      .value("KEY_Backslash", osgGA::GUIEventAdapter::KeySymbol::KEY_Backslash)
      .value("KEY_Rightbracket", osgGA::GUIEventAdapter::KeySymbol::KEY_Rightbracket)
      .value("KEY_Caret", osgGA::GUIEventAdapter::KeySymbol::KEY_Caret)
      .value("KEY_Underscore", osgGA::GUIEventAdapter::KeySymbol::KEY_Underscore)
      ...
      .value("KEY_Scroll_Lock", osgGA::GUIEventAdapter::KeySymbol::KEY_Scroll_Lock)
      ...
      .value("KEY_Mode_switch", osgGA::GUIEventAdapter::KeySymbol::KEY_Mode_switch)
      .value("KEY_Script_switch", osgGA::GUIEventAdapter::KeySymbol::KEY_Script_switch)
      ...
      .value("KEY_KP_Page_Up", osgGA::GUIEventAdapter::KeySymbol::KEY_KP_Page_Up)
      .value("KEY_KP_Next", osgGA::GUIEventAdapter::KeySymbol::KEY_KP_Next)
      .value("KEY_KP_Page_Down", osgGA::GUIEventAdapter::KeySymbol::KEY_KP_Page_Down)
      ...
      .value("KEY_KP_Multiply", osgGA::GUIEventAdapter::KeySymbol::KEY_KP_Multiply)
      .value("KEY_KP_Add", osgGA::GUIEventAdapter::KeySymbol::KEY_KP_Add)
      .value("KEY_KP_Separator", osgGA::GUIEventAdapter::KeySymbol::KEY_KP_Separator)
      .value("KEY_KP_Subtract", osgGA::GUIEventAdapter::KeySymbol::KEY_KP_Subtract)
      .value("KEY_KP_Decimal", osgGA::GUIEventAdapter::KeySymbol::KEY_KP_Decimal)
      ...
      .value("KEY_Shift_Lock", osgGA::GUIEventAdapter::KeySymbol::KEY_Shift_Lock)
  ...
  nb::enum_<osgGA::GUIEventAdapter::ModKeyMask>(ea, "ModKeyMask")
      .value("MODKEY_LEFT_SHIFT", osgGA::GUIEventAdapter::ModKeyMask::MODKEY_LEFT_SHIFT)
      .value("MODKEY_RIGHT_SHIFT", osgGA::GUIEventAdapter::ModKeyMask::MODKEY_RIGHT_SHIFT)
      .value("MODKEY_LEFT_CTRL", osgGA::GUIEventAdapter::ModKeyMask::MODKEY_LEFT_CTRL)
      .value("MODKEY_RIGHT_CTRL", osgGA::GUIEventAdapter::ModKeyMask::MODKEY_RIGHT_CTRL)
      .value("MODKEY_LEFT_ALT", osgGA::GUIEventAdapter::ModKeyMask::MODKEY_LEFT_ALT)
      .value("MODKEY_RIGHT_ALT", osgGA::GUIEventAdapter::ModKeyMask::MODKEY_RIGHT_ALT)
      .value("MODKEY_LEFT_META", osgGA::GUIEventAdapter::ModKeyMask::MODKEY_LEFT_META)
      .value("MODKEY_RIGHT_META", osgGA::GUIEventAdapter::ModKeyMask::MODKEY_RIGHT_META)
      .value("MODKEY_LEFT_SUPER", osgGA::GUIEventAdapter::ModKeyMask::MODKEY_LEFT_SUPER)
      .value("MODKEY_RIGHT_SUPER", osgGA::GUIEventAdapter::ModKeyMask::MODKEY_RIGHT_SUPER)
      .value("MODKEY_LEFT_HYPER", osgGA::GUIEventAdapter::ModKeyMask::MODKEY_LEFT_HYPER)
      .value("MODKEY_RIGHT_HYPER", osgGA::GUIEventAdapter::ModKeyMask::MODKEY_RIGHT_HYPER)
      .value("MODKEY_NUM_LOCK", osgGA::GUIEventAdapter::ModKeyMask::MODKEY_NUM_LOCK)
      .value("MODKEY_CAPS_LOCK", osgGA::GUIEventAdapter::ModKeyMask::MODKEY_CAPS_LOCK)
  ...
  nb::enum_<osgGA::GUIEventAdapter::MouseYOrientation>(ea, "MouseYOrientation")
      .value("Y_INCREASING_UPWARDS", osgGA::GUIEventAdapter::MouseYOrientation::Y_INCREASING_UPWARDS)
      .value("Y_INCREASING_DOWNWARDS", osgGA::GUIEventAdapter::MouseYOrientation::Y_INCREASING_DOWNWARDS)
      .export_values();

  nb::enum_<osgGA::GUIEventAdapter::ScrollingMotion>(ea, "ScrollingMotion")
      .value("SCROLL_NONE", osgGA::GUIEventAdapter::ScrollingMotion::SCROLL_NONE)
      .value("SCROLL_LEFT", osgGA::GUIEventAdapter::ScrollingMotion::SCROLL_LEFT)
      .value("SCROLL_RIGHT", osgGA::GUIEventAdapter::ScrollingMotion::SCROLL_RIGHT)
      .value("SCROLL_UP", osgGA::GUIEventAdapter::ScrollingMotion::SCROLL_UP)
      .value("SCROLL_DOWN", osgGA::GUIEventAdapter::ScrollingMotion::SCROLL_DOWN)
  ...
  nb::enum_<osgGA::GUIEventAdapter::TouchPhase>(ea, "TouchPhase")
      ...
      .value("TOUCH_STATIONERY", osgGA::GUIEventAdapter::TouchPhase::TOUCH_STATIONERY)
