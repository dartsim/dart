...
{
  nb::class_<dart::gui::osg::ImGuiWidget>(m, "ImGuiWidget")
      .def("render", &dart::gui::osg::ImGuiWidget::render)
      .def(
          "setVisible",
          ...
          nb::arg("visible"))
      .def("toggleVisible", &dart::gui::osg::ImGuiWidget::toggleVisible)
      .def("show", &dart::gui::osg::ImGuiWidget::show)
      .def("hide", &dart::gui::osg::ImGuiWidget::hide)
      .def("isVisible", &dart::gui::osg::ImGuiWidget::isVisible);
}

void defImGuiHandler(nb::module_& m)
{
  using dart::gui::osg::ImGuiHandler;

  nb::class_<ImGuiHandler>(m, "ImGuiHandler")
      .def(nb::init<>())
      .def(
          "newFrame",
          [](ImGuiHandler& self, osg::RenderInfo& info) { self.newFrame(info); },
          nb::arg("renderInfo"))
      .def(
          "render",
      ...
      .def(
          ...
          [](ImGuiHandler& self,
            ...
            return self.handle(eventAdapter, actionAdapter, object, nodeVisitor);
          },
          nb::arg("eventAdapter"),
...
void defImGuiViewer(nb::module_& m)
{
  ...
  nb::class_<ImGuiViewer, dart::gui::osg::Viewer>(m, "ImGuiViewer")
      .def(nb::init<>())
      .def(
          "__init__",
          [](ImGuiViewer* self, const Eigen::Vector4d& clearColor) {
            new (self) ImGuiViewer(dart::gui::osg::eigToOsgVec4f(clearColor));
          },
          nb::arg("clearColor"))
