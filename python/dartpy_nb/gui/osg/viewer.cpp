...
void defViewer(nb::module_& m)
{
  ...
  auto viewer = nb::class_<Viewer, osgViewer::View>(m, "Viewer")
                    ...
                    .def(
                        ...
                        [](Viewer& self,
                           ...
                           const std::string& prefix,
                           bool restart) {
                          self.record(directory, prefix, restart);
                        },
                        nb::arg("directory"),
                        nb::arg("prefix"),
                        nb::arg("restart"))
                    ...
                    .def(
                        ...
                        [](Viewer& self, bool on) { self.switchDefaultEventHandler(on); },
                        nb::arg("on"))
                    .def(
                        "switchHeadlights",
                    ...
                    .def("setLightingMode", &Viewer::setLightingMode, nb::arg("lightingMode"))
                    .def("getLightingMode", &Viewer::getLightingMode)
                    .def(
                        "addWorldNode",
                        [](Viewer& self, dart::gui::osg::WorldNode* node) {
                    ...
                    .def(
                        ...
                        [](Viewer& self,
                           ...
                           bool active) { self.addWorldNode(node, active); },
                        nb::arg("newWorldNode"),
                        nb::arg("active"))
                    .def(
                        "removeWorldNode",
                    ...
                    .def(
                        "removeWorldNode",
                        [](Viewer& self, std::shared_ptr<dart::simulation::World> world) {
                          self.removeWorldNode(std::move(world));
                        },
                        nb::arg("oldWorld"))
                    .def(
                        "addAttachment",
                        [](Viewer& self, dart::gui::osg::ViewerAttachment* attachment) {
                    ...
                    .def(
                        "setWorldNodeActive",
                        [](Viewer& self, dart::gui::osg::WorldNode* node, bool active) {
                    ...
                    .def(
                        ...
                        [](Viewer& self,
                           ...
                           bool active) { self.setWorldNodeActive(std::move(world), active); },
                        nb::arg("world"),
                        nb::arg("active"))
                    ...
                    .def(
                        "enableDragAndDrop",
                        [](Viewer& self, dart::gui::osg::InteractiveFrame* frame) {
                    ...
                    .def(
                        "disableDragAndDrop",
                        [](Viewer& self, dart::gui::osg::InteractiveFrameDnD* dnd) {
                          self.disableDragAndDrop(dnd);
                        },
                        nb::arg("dnd"))
                    .def(
                        "disableDragAndDrop",
                        [](Viewer& self, dart::gui::osg::SimpleFrameDnD* dnd) {
                          self.disableDragAndDrop(dnd);
                        },
                        nb::arg("dnd"))
                    .def(
                        "disableDragAndDrop",
                        [](Viewer& self, dart::gui::osg::SimpleFrameShapeDnD* dnd) {
                          self.disableDragAndDrop(dnd);
                        },
                        nb::arg("dnd"))
                    .def(
                        "disableDragAndDrop",
                        [](Viewer& self, dart::gui::osg::BodyNodeDnD* dnd) {
                          self.disableDragAndDrop(dnd);
                        },
                        nb::arg("dnd"))
                    .def(
                        "disableDragAndDrop",
                        [](Viewer& self, dart::gui::osg::DragAndDrop* dnd) {
                          self.disableDragAndDrop(dnd);
                        },
                        nb::arg("dnd"))
                    .def(
                    ...
                    .def(
                        ...
                        [](Viewer& self, double fov) { self.setVerticalFieldOfView(fov); },
                        nb::arg("fov"))
                        ...
                        [](Viewer& self,
                          ...
                          if (manip) {
                            manip->setHomePosition(
                                dart::gui::osg::eigToOsgVec3(e),
                                dart::gui::osg::eigToOsgVec3(c),
                                dart::gui::osg::eigToOsgVec3(u));
  ...
  nb::enum_<dart::gui::osg::CameraMode>(m, "CameraMode")
