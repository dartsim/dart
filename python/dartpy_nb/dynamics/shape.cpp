...
void defShape(nb::module_& m)
{
  ...
  nb::class_<Shape, std::shared_ptr<Shape>>(m, "Shape")
      .def("getType",
  ...
  nb::class_<dart::dynamics::SphereShape, Shape, std::shared_ptr<dart::dynamics::SphereShape>>(m, "SphereShape")
      .def(nb::init<double>(), nb::arg("radius"))
      .def("setRadius", &dart::dynamics::SphereShape::setRadius, nb::arg("radius"))
      ...
      .def_static("getStaticType",
          ...
          nb::rv_policy::reference_internal)
      .def_static("computeVolumeOf",
          [](double radius) {
            return dart::dynamics::SphereShape::computeVolume(radius);
          },
          nb::arg("radius"))
      .def_static("computeInertiaOf",
  ...
  nb::class_<dart::dynamics::BoxShape, Shape, std::shared_ptr<dart::dynamics::BoxShape>>(m, "BoxShape")
      .def(nb::init<const Eigen::Vector3d&>(), nb::arg("size"))
      .def("setSize", &dart::dynamics::BoxShape::setSize, nb::arg("size"))
      .def("getSize",
          [](const dart::dynamics::BoxShape& self) {
            return self.getSize();
          })
      .def("computeInertia",
