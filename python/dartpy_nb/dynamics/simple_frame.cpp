...
void defSimpleFrame(nb::module_& m)
{
  ...
  nb::class_<SimpleFrame, dart::dynamics::ShapeFrame, std::shared_ptr<SimpleFrame>>(m, "SimpleFrame")
      .def(nb::init<>())
      .def(nb::init<Frame*>(), nb::arg("refFrame"))
      .def(nb::init<Frame*, const std::string&>(), nb::arg("refFrame"), nb::arg("name"))
      .def(nb::init<Frame*, const std::string&, const Eigen::Isometry3d&>(),
          nb::arg("refFrame"),
          nb::arg("name"),
          nb::arg("relativeTransform"))
      .def("isShapeFrame", [](const SimpleFrame& self) { return self.isShapeFrame(); })
      .def("isShapeNode", [](const SimpleFrame& self) { return self.isShapeNode(); })
      ...
      .def("setTranslation",
          ...
          nb::arg("newTranslation"))
      .def("setTranslation",
          [](SimpleFrame& self, const Eigen::Vector3d& translation, const Frame* withRespectTo) {
            const Frame* target = withRespectTo ? withRespectTo : Frame::World();
      ...
      .def("setTransform",
          ...
          nb::arg("newTransform"))
      .def("setTransform",
          [](SimpleFrame& self, const Eigen::Isometry3d& transform, const Frame* withRespectTo) {
            const Frame* target = withRespectTo ? withRespectTo : Frame::World();
