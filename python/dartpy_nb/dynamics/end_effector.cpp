...
void defEndEffector(nb::module_& m)
{
  ...
  nb::class_<Support>(m, "Support")
      .def(
          ...
          nb::arg("geometry"))
      .def("getGeometry", [](const Support& self) { return self.getGeometry(); })
      .def(
          "setActive",
  ...
  nb::class_<EndEffector, dart::dynamics::JacobianNode>(m, "EndEffector")
      .def(
          ...
          [](EndEffector& self,
             ...
             bool useNow) { self.setDefaultRelativeTransform(transform, useNow); },
          nb::arg("transform"),
          nb::arg("useNow") = false)
      .def(
          "getName",
      ...
      .def("resetRelativeTransform", [](EndEffector& self) {
      ...
      .def(
          ...
          nb::rv_policy::reference_internal,
          nb::arg("createIfNull"))
      .def("hasSupport", [](const EndEffector& self) { return self.hasSupport(); })
