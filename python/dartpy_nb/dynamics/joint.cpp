...
void defJoint(nb::module_& m)
{
  ...
  nb::class_<Joint, std::shared_ptr<Joint>>(m, "Joint")
      ...
      .def("getDof",
          ...
          nb::arg("index"))
      .def("getDof",
          [](Joint& self, const std::string& name) -> dart::dynamics::DegreeOfFreedom* {
            return self.getDof(name);
          },
          nb::rv_policy::reference_internal,
          nb::arg("name"))
      .def("setDofName",
          [](Joint& self, std::size_t index, const std::string& name) -> const std::string& {
          ...
          nb::arg("name"))
      .def("setDofName",
          [](Joint& self, std::size_t index, const std::string& name, bool preserve) -> const std::string& {
