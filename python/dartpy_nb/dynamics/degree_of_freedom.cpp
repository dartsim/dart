...
void defDegreeOfFreedom(nb::module_& m)
{
  ...
  nb::class_<DegreeOfFreedom, dart::common::Subject, std::shared_ptr<DegreeOfFreedom>>(m, "DegreeOfFreedom")
      .def("setName",
          [](DegreeOfFreedom& self, const std::string& name) -> const std::string& {
            return self.setName(name);
          },
          nb::rv_policy::reference_internal,
          nb::arg("name"))
      .def("setName",
          [](DegreeOfFreedom& self, const std::string& name, bool preserve_name) -> const std::string& {
      ...
      .def("setVelocityLowerLimit",
          [](DegreeOfFreedom& self, double limit) {
            self.setVelocityLowerLimit(limit);
          },
          nb::arg("limit"))
      .def("getVelocityLowerLimit",
          [](const DegreeOfFreedom& self) -> double {
            return self.getVelocityLowerLimit();
          })
      .def("setVelocityUpperLimit",
          [](DegreeOfFreedom& self, double limit) {
            self.setVelocityUpperLimit(limit);
          },
          nb::arg("limit"))
      .def("getVelocityUpperLimit",
          [](const DegreeOfFreedom& self) -> double {
      ...
      .def("setAccelerationUpperLimit",
          ...
          nb::arg("limit"))
      .def("getAccelerationUpperLimit",
          [](const DegreeOfFreedom& self) -> double {
            return self.getAccelerationUpperLimit();
          })
      .def("setForce",
          [](DegreeOfFreedom& self, double force) {
            self.setForce(force);
          },
          nb::arg("force"))
      .def("getForce",
