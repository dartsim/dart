...
void defInertia(nb::module_& m)
{
  ...
  nb::class_<Inertia, std::shared_ptr<Inertia>>(m, "Inertia")
      ...
      .def("getLocalCOM", &Inertia::getLocalCOM, nb::rv_policy::reference_internal)
      .def("setMoment",
          nb::overload_cast<const Eigen::Matrix3d&>(&Inertia::setMoment),
          nb::arg("moment"))
      .def("getMoment", &Inertia::getMoment)
      .def("setSpatialTensor", nb::overload_cast<const Eigen::Matrix6d&>(&Inertia::setSpatialTensor), nb::arg("spatial"))
      .def("setSpatialTensor",
          nb::overload_cast<const Eigen::Matrix6d&, bool>(&Inertia::setSpatialTensor),
          nb::arg("spatial"),
          nb::arg("printWarnings"))
      .def("getSpatialTensor", &Inertia::getSpatialTensor, nb::rv_policy::reference_internal)
      .def("transformed", &Inertia::transformed, nb::arg("transform"))
      .def("transform", &Inertia::transform, nb::arg("transform"), nb::rv_policy::reference_internal)
      .def("verify",
          &Inertia::verify,
          nb::arg("printWarnings") = true,
          nb::arg("tolerance") = 1e-8)
      .def("__eq__", [](const Inertia& self, const Inertia& other) { return self == other; })
      .def_static("verifyMoment",
          &Inertia::verifyMoment,
          nb::arg("moment"),
          nb::arg("printWarnings") = true,
          nb::arg("tolerance") = 1e-8)
      .def_static("verifySpatialTensor",
