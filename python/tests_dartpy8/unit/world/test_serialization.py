...
class TestSerializationBasics:
    ...
    def test_two_link_chain(self):
        ...
        assert joint1_restored.get_type() == dart8.JointType.Revolute
...
class TestSerializationComplexHierarchies:
    ...
    def test_complex_hierarchy(self):
        ...
        assert shoulder_pan.get_type() == dart8.JointType.Revolute
        ...
        assert shoulder_lift.get_type() == dart8.JointType.Revolute
        ...
        assert elbow.get_type() == dart8.JointType.Revolute

        wrist_1 = robot_restored.get_joint("wrist_1")
        assert wrist_1 is not None
        assert wrist_1.get_type() == dart8.JointType.Revolute

        wrist_2 = robot_restored.get_joint("wrist_2")
        assert wrist_2 is not None
        assert wrist_2.get_type() == dart8.JointType.Revolute
        ...
        assert wrist_3.get_type() == dart8.JointType.Revolute
