"""Headless smoke for the sx variational-contact showcase.

Build the ``sx_variational_contact`` scene and step the underlying sx::World
...
def test_sx_variational_contact_catches_tip_on_ground() -> None:
    _sx()  # skip cleanly if experimental is unavailable
    from examples.demos.scenes.sx_variational_contact import build
