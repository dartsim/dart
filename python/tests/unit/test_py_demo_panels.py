...
def test_rigid_workflow_search_finds_user_terminology_aliases() -> None:
    route_cases = (
        ...
        ("ray-cast", "rigid_collision_casts"),
        ("shape-cast", "rigid_collision_casts"),
        ...
        ("body kind filters", "rigid_collision_query_options"),
        ...
        ("Multibody.computeImpulseResponse", "rigid_multibody_dynamics_terms"),
        ("impulse response", "rigid_multibody_dynamics_terms"),
        ("RigidBody.apply_linear_impulse", "rigid_external_loads"),
        ("RigidBody.applyLinearImpulse", "rigid_external_loads"),
        ...
        ("resting contacts", "rigid_stack_stability"),
