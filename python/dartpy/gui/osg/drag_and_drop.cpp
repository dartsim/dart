...
void defDragAndDrop(nb::module_& m)
{
  ...
  nb::class_<dart::gui::osg::BodyNodeDnD, DragAndDrop>(m, "BodyNodeDnD")
      ...
      .def(
          ...
          &dart::gui::osg::BodyNodeDnD::getPreserveOrientationModKey)
      .def(
      ...
      .def(
          ...
          &dart::gui::osg::BodyNodeDnD::getJointRestrictionModKey);

  nb::class_<dart::gui::osg::InteractiveFrameDnD, DragAndDrop>(
