...
{
  nb::class_<dart::gui::osg::ViewerAttachment>(m, "ViewerAttachment")
      .def("refresh", &dart::gui::osg::ViewerAttachment::refresh);
}

void defGridVisual(nb::module_& m)
{
  using dart::gui::osg::GridVisual;

  auto grid
      = nb::class_<GridVisual, dart::gui::osg::ViewerAttachment>(
            m, "GridVisual")
...
{
  using dart::gui::osg::PolyhedronVisual;

  nb::class_<PolyhedronVisual, dart::gui::osg::ViewerAttachment>(
      m, "PolyhedronVisual")
