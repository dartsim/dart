...
class MultibodyOptions:
    def __init__(self, integration_family: str = ..., variational_max_iterations: int = ..., variational_tolerance: float = ...) -> None: ...
...
class World:
    ...
    def set_collision_pair_ignored(self, first: object, second: object, ignored: bool = ...) -> None: ...

    def is_collision_pair_ignored(self, first: object, second: object) -> bool: ...
