...
class Joint:
    ...
    @property
    def avbd_start_stiffness(self) -> float: ...

    @avbd_start_stiffness.setter
    def avbd_start_stiffness(self, arg: float, /) -> None: ...

    @property
    def avbd_linear_stiffness(self) -> float: ...

    @avbd_linear_stiffness.setter
    def avbd_linear_stiffness(self, arg: float, /) -> None: ...

    @property
    def avbd_angular_stiffness(self) -> float: ...

    @avbd_angular_stiffness.setter
    def avbd_angular_stiffness(self, arg: float, /) -> None: ...
...
class World:
    ...
    @overload
    def add_articulated_fixed_joint(self, name: str, parent: Link, child: Link, *, parent_anchor: object | None = ..., child_anchor: object | None = ...) -> Joint: ...

    @overload
    def add_articulated_fixed_joint(self, name: str, child: Link, *, world_anchor: object | None = ..., child_anchor: object | None = ...) -> Joint: ...

    @overload
    def add_articulated_revolute_joint(self, name: str, parent: Link, child: Link, axis: object = ..., *, parent_anchor: object | None = ..., child_anchor: object | None = ...) -> Joint: ...

    @overload
    def add_articulated_revolute_joint(self, name: str, child: Link, axis: object = ..., *, world_anchor: object | None = ..., child_anchor: object | None = ...) -> Joint: ...

    @overload
    def add_articulated_prismatic_joint(self, name: str, parent: Link, child: Link, axis: object = ..., *, parent_anchor: object | None = ..., child_anchor: object | None = ...) -> Joint: ...

    @overload
    def add_articulated_prismatic_joint(self, name: str, child: Link, axis: object = ..., *, world_anchor: object | None = ..., child_anchor: object | None = ...) -> Joint: ...

    @overload
    def add_articulated_spherical_joint(self, name: str, parent: Link, child: Link, *, parent_anchor: object | None = ..., child_anchor: object | None = ...) -> Joint: ...

    @overload
    def add_articulated_spherical_joint(self, name: str, child: Link, *, world_anchor: object | None = ..., child_anchor: object | None = ...) -> Joint: ...

    def get_articulated_joint(self, name: str) -> object: ...

    def has_articulated_joint(self, name: str) -> bool: ...

    def get_articulated_joints(self) -> list: ...
    ...
    @overload
    def add_rigid_body_spherical_joint(self, name: str, parent: RigidBody, child: RigidBody) -> Joint: ...

    @overload
    def add_rigid_body_spherical_joint(self, name: str, parent: RigidBody, child: RigidBody, *, parent_anchor: object, child_anchor: object) -> Joint: ...
    ...
    @property
    def num_articulated_joints(self) -> int: ...
