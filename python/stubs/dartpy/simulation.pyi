...
class DeformableSolverDiagnostics:
    ...
    @property
    def vbd_body_count(self) -> int: ...

    @property
    def vbd_sweeps(self) -> int: ...

    @property
    def vbd_vertex_updates(self) -> int: ...
    ...
    @property
    def surface_contact_candidate_capacity_requested(self) -> int: ...

    @property
    def surface_contact_candidate_capacity_resolved(self) -> int: ...

    @property
    def surface_contact_candidate_count_peak(self) -> int: ...
    @property
    def surface_contact_candidate_overflow_count(self) -> int: ...
...
class DeformableBodyOptions:
    ...
    @property
    def surface_contact_candidate_capacity(self) -> int: ...

    @surface_contact_candidate_capacity.setter
    def surface_contact_candidate_capacity(self, arg: int, /) -> None: ...
...
class World:
    ...
    def get_last_contact_forces(self) -> list[ContactForce]: ...
    ...
    @property
    def rigid_collision_candidate_pair_capacity(self) -> int: ...

    @property
    def rigid_collision_contact_capacity(self) -> int: ...
    ...
    @property
    def num_rigid_body_dofs(self) -> int: ...

    @property
    def num_rigid_body_efforts(self) -> int: ...
    ...
    @property
    def rigid_body_state_vector(self) -> Annotated[NDArray[numpy.float64], dict(shape=(None,), order='C')]: ...

    @rigid_body_state_vector.setter
    def rigid_body_state_vector(self, arg: object, /) -> None: ...

    @property
    def rigid_body_control_vector(self) -> Annotated[NDArray[numpy.float64], dict(shape=(None,), order='C')]: ...

    @rigid_body_control_vector.setter
    def rigid_body_control_vector(self, arg: object, /) -> None: ...
