...
class Joint(dartpy.common.Subject, EmbedProperties_Joint_JointProperties):
    ...
    def getActuatorType(self) -> ActuatorType:
        ...
    def getActuatorTypeForDof(self, index: int) -> ActuatorType:
        ...
    def getActuatorTypes(self) -> list[ActuatorType]:
        ...
    def hasActuatorType(self, actuatorType: ActuatorType) -> bool:
        ...
    ...
    def setActuatorType(self, actuatorType: ActuatorType) -> None:
        ...
    def setActuatorTypeForDof(self, index: int, actuatorType: ActuatorType) -> None:
        ...
    def setActuatorTypes(self, actuatorTypes: typing.Iterable[ActuatorType]) -> None:
        ...
...
class JointProperties:
    ...
    mActuatorTypes: dict[int, ActuatorType]
