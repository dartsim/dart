...
class Viewer(osgViewer, dartpy.common.Subject):
    ...
    class ThreadingModel:
        ...
        Members:
          ...
          AutomaticSelection
        """
        AutomaticSelection: typing.ClassVar[Viewer.ThreadingModel]  # value = <ThreadingModel.AutomaticSelection: 4>
        CullDrawThreadPerContext: typing.ClassVar[Viewer.ThreadingModel]  # value = <ThreadingModel.CullDrawThreadPerContext: 1>
        CullThreadPerCameraDrawThreadPerContext: typing.ClassVar[Viewer.ThreadingModel]  # value = <ThreadingModel.CullThreadPerCameraDrawThreadPerContext: 3>
        DrawThreadPerContext: typing.ClassVar[Viewer.ThreadingModel]  # value = <ThreadingModel.DrawThreadPerContext: 2>
        SingleThreaded: typing.ClassVar[Viewer.ThreadingModel]  # value = <ThreadingModel.SingleThreaded: 0>
        ThreadPerCamera: typing.ClassVar[Viewer.ThreadingModel]  # value = <ThreadingModel.ThreadPerCamera: 3>
        ThreadPerContext: typing.ClassVar[Viewer.ThreadingModel]  # value = <ThreadingModel.ThreadPerContext: 1>
        __members__: typing.ClassVar[dict[str, Viewer.ThreadingModel]]  # value = {'SingleThreaded': <ThreadingModel.SingleThreaded: 0>, 'CullDrawThreadPerContext': <ThreadingModel.CullDrawThreadPerContext: 1>, 'ThreadPerContext': <ThreadingModel.ThreadPerContext: 1>, 'DrawThreadPerContext': <ThreadingModel.DrawThreadPerContext: 2>, 'CullThreadPerCameraDrawThreadPerContext': <ThreadingModel.CullThreadPerCameraDrawThreadPerContext: 3>, 'ThreadPerCamera': <ThreadingModel.ThreadPerCamera: 3>, 'AutomaticSelection': <ThreadingModel.AutomaticSelection: 4>}
        def __eq__(self, other: typing.Any) -> bool:
            ...
        def __getstate__(self) -> int:
            ...
    ...
    def run(self) -> int:
        ...
    def getKeyEventSetsDone(self) -> int:
        ...
    def setKeyEventSetsDone(self, key: int) -> None:
        ...
    def getQuitEventSetsDone(self) -> bool:
        ...
    def setQuitEventSetsDone(self, flag: bool) -> None:
        ...
    ...
    def setLightingMode(self, lightingMode: ...) -> None:
        ...
    def setThreadingModel(self, threadingModel: ...) -> None:
        ...
