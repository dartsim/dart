...
class PanelBuilder:
    ...
    def slider(self, label: str, value: float, minimum: float, maximum: float) -> tuple[bool, float]: ...
    def color_edit(self, label: str, rgba: Annotated[NDArray[numpy.float64], dict(shape=(4), order='C')]) -> tuple[bool, Annotated[NDArray[numpy.float64], dict(shape=(4), order='C')]]: ...
    def select(self, label: str, selected_index: int, choices: Sequence[str]) -> tuple[bool, int]: ...
    def color_swatch(self, label: str, rgba: Annotated[NDArray[numpy.float64], dict(shape=(4), order='C')]) -> None: ...
...
class PanelContext:
    ...
    @property
    def selected_point(self) -> Annotated[NDArray[numpy.float64], dict(shape=(3), order='C')] | None: ...

    @property
    def selected_normal(self) -> Annotated[NDArray[numpy.float64], dict(shape=(3), order='C')] | None: ...
    ...
    @property
    def display_size(self) -> Annotated[NDArray[numpy.float64], dict(shape=(2), order='C')]: ...
