...
@overload
def add_world(world: object, source_world: dartpy.simulation.World, options: SkeletonLoadOptions = ...) -> list: ...
...
class World:
    ...
    def add_rigid_body_fixed_joint(self, name: str, parent: RigidBody, child: RigidBody) -> Joint: ...

    def add_rigid_body_revolute_joint(self, name: str, parent: RigidBody, child: RigidBody, axis: object = ...) -> Joint: ...

    def add_rigid_body_prismatic_joint(self, name: str, parent: RigidBody, child: RigidBody, axis: object = ...) -> Joint: ...

    def get_rigid_body_joint(self, name: str) -> object: ...

    def has_rigid_body_joint(self, name: str) -> bool: ...

    def get_rigid_body_joints(self) -> list: ...

    def get_rigid_body_fixed_joint(self, name: str) -> object: ...

    def has_rigid_body_fixed_joint(self, name: str) -> bool: ...

    def get_rigid_body_fixed_joints(self) -> list: ...
    ...
    @property
    def num_rigid_body_joints(self) -> int: ...

    @property
    def num_rigid_body_fixed_joints(self) -> int: ...
