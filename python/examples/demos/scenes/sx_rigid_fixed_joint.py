"""Rigid-body fixed-joint scene for the experimental World facade."""
...
def build() -> SceneSetup:
    ...
    bridge = SxRenderBridge(world, name="sx_rigid_fixed_joint_render")
...
SCENE = PythonDemoScene(
    id="sx_rigid_fixed_joint",
    title="Rigid Fixed Joint (sx)",
