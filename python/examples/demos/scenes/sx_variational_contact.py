...
``add_ground_contact_point``), and the experimental World's variational
...
sx::World owns the physics; SxRenderBridge mirrors each link's world transform
...
def build() -> SceneSetup:
    ...
    bridge = SxRenderBridge(world, name="sx_variational_contact_render")
