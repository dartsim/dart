...
To run the free-joint-cases fixture:
...
```bash
pixi run ex filament_gui --scene atlas-simbicon
```
...
To run the wam-ikfast fixture:

```bash
pixi run ex filament_gui --scene wam-ikfast
```

To run the fetch fixture:
