...
- **OSG Port**: This example keeps the legacy rigid-cube interaction behavior on the OSG viewer
...
- **Force Management**: Implements the same force application and decay logic as the legacy version
