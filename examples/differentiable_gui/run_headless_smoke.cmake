...
if(NOT _stdout STREQUAL "")
  message(STATUS "differentiable_gui stdout:\n${_stdout}")
endif()
if(NOT _stderr STREQUAL "")
  message(STATUS "differentiable_gui stderr:\n${_stderr}")
endif()
if(NOT _result STREQUAL "0")
  message(
    FATAL_ERROR
    "differentiable_gui headless smoke failed with exit code ${_result}"
  )
endif()

if(NOT EXISTS "${_screenshot}")
  message(FATAL_ERROR "differentiable_gui did not write ${_screenshot}")
endif()
...
message(
  STATUS
  "differentiable_gui headless smoke wrote ${_screenshot} (${_screenshot_size} bytes, non-blank)"
)
