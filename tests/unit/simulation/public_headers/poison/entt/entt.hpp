...
#error                                                                         \
    "EnTT leaked into the dart::simulation public header surface. A promoted public header (transitively) includes <entt/...>; move that include behind a detail/internal header. See tests/unit/simulation/public_headers and scripts/audit_dart7_promotion_surface.py --strict."
