...
using dart::collision::native::GjkResult;
using dart::collision::native::Mpr;
using dart::collision::native::MprResult;
using dart::collision::native::SupportFunction;
namespace expc = dart::collision::native;
...
[[maybe_unused]] bool nearVector(
    const Eigen::Vector3d& a, const Eigen::Vector3d& b, double tol)
{
  return (a - b).norm() <= tol;
}
...
RaycastBackendResult queryNativeRaycast(
    const Eigen::Vector3d& pos,
