    ...
    int variantsPerBoxCount, std::size_t iterations, std::string& errorMessage)
{
  ...
  constexpr std::array<int, 9> kBoxCounts{1, 2, 4, 8, 16, 24, 32, 48, 64};
    ...
    std::string& errorMessage)
{
  ...
  constexpr std::array<int, 9> kSphereCounts{2, 3, 4, 5, 6, 7, 8, 9, 10};
...
{
  constexpr std::array<MildIllConditionedBenchmarkCase, 41> cases{
...
{
  constexpr std::array<NearSingularBenchmarkCase, 14> cases{
...
{
  constexpr std::array<SingularDegenerateBenchmarkCase, 10> cases{
