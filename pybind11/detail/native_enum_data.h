...
//
// This header mirrors pybind11/detail/native_enum_data.h from pybind11 3.0.1,
// but fixes a series of malformed string literals that break compilation when
// building against that release. See:
// https://github.com/pybind/pybind11/pull/4854
