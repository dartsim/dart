/*
 * Convenience umbrella header for the DART GUI module.
 *
 * This header preserves the pre-rename include path used by examples,
 * tutorials, and bindings by re-exporting the public GUI headers from their
 * new locations.
 */
