...
ODE_API void dMultiply0(
    dReal* A, const dReal* B, const dReal* C, int p, int q, int r);
ODE_API void dMultiply1(
    dReal* A, const dReal* B, const dReal* C, int p, int q, int r);
ODE_API void dMultiply2(
    dReal* A, const dReal* B, const dReal* C, int p, int q, int r);
...
ODE_API void dSolveLDLT(
    const dReal* L, const dReal* d, dReal* b, int n, int nskip);
...
#define dLDLTAddTL(L, d, a, n, nskip, tmpbuf)                                  \
  _dLDLTAddTL(L, d, a, n, nskip, tmpbuf)
#define dLDLTRemove(A, p, L, d, n1, n2, r, nskip, tmpbuf)                      \
  _dLDLTRemove(A, p, L, d, n1, n2, r, nskip, tmpbuf)
#define dRemoveRowCol(A, n, nskip, r) _dRemoveRowCol(A, n, nskip, r)

#define dEstimateFactorCholeskyTmpbufSize(n)                                   \
  _dEstimateFactorCholeskyTmpbufSize(n)
#define dEstimateSolveCholeskyTmpbufSize(n) _dEstimateSolveCholeskyTmpbufSize(n)
#define dEstimateInvertPDMatrixTmpbufSize(n)                                   \
  _dEstimateInvertPDMatrixTmpbufSize(n)
#define dEstimateIsPositiveDefiniteTmpbufSize(n)                               \
  _dEstimateIsPositiveDefiniteTmpbufSize(n)
#define dEstimateLDLTAddTLTmpbufSize(nskip) _dEstimateLDLTAddTLTmpbufSize(nskip)
#define dEstimateLDLTRemoveTmpbufSize(n2, nskip)                               \
  _dEstimateLDLTRemoveTmpbufSize(n2, nskip)
