...
//----------------------------------------------------------------------
extern ANNsampStat ann_average_err;	// average error
extern ANNsampStat ann_rank_err;	// rank error

//----------------------------------------------------------------------
//	Declaration of externally accessible routines for statistics
//----------------------------------------------------------------------

void annResetStats(int data_size);	// reset stats for a set of queries

void annResetCounts();				// reset counts for one queries

void annUpdateStats();				// update stats with current counts

void annPrintStats(ANNbool validate); // print statistics for a run
